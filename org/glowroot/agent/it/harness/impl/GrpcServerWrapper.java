...
import org.glowroot.agent.it.harness.shaded.grpc.Server;
import org.glowroot.agent.it.harness.shaded.grpc.netty.NettyServerBuilder;
...
class GrpcServerWrapper {
    ...
    void close() throws InterruptedException {
        ...
        // org.glowroot.agent.it.harness.shaded.grpc.netty.NettyServerHandler - Connection Error: RejectedExecutionException
        Thread.sleep(100);
        executor.shutdown();
