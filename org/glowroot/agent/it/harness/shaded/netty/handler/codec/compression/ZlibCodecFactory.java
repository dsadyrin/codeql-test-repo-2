...
public final class ZlibCodecFactory {
    ...
    static {
        noJdkZlibDecoder = SystemPropertyUtil.getBoolean("org.glowroot.agent.it.harness.shaded.netty.noJdkZlibDecoder",
                PlatformDependent.javaVersion() < 7);
        logger.debug("-Dio.netty.noJdkZlibDecoder: {}", noJdkZlibDecoder);

        noJdkZlibEncoder = SystemPropertyUtil.getBoolean("org.glowroot.agent.it.harness.shaded.netty.noJdkZlibEncoder", false);
