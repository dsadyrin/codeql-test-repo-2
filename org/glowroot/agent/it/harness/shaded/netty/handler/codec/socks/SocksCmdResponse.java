 ...
 * under the License.
 */
package org.glowroot.agent.it.harness.shaded.netty.handler.codec.socks;
...
public final class SocksCmdResponse extends SocksResponse {
    ...
    /**
     * Returns host that is used as a parameter in {@link org.glowroot.agent.it.harness.shaded.netty.handler.codec.socks.SocksCmdType}.
     ...
     *
     * @return host that is used as a parameter in {@link org.glowroot.agent.it.harness.shaded.netty.handler.codec.socks.SocksCmdType}
    ...
    /**
     * Returns port that is used as a parameter in {@link org.glowroot.agent.it.harness.shaded.netty.handler.codec.socks.SocksCmdType}.
     * Port (BND.PORT field in response) is port that the server assigned to connect to the target host.
     *
     * @return port that is used as a parameter in {@link org.glowroot.agent.it.harness.shaded.netty.handler.codec.socks.SocksCmdType}
     */
    public int port() {
        return port;
    }
