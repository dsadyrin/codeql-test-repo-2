...
public interface Http2Connection {
    ...
    interface Listener {
         ...
         * Http2FrameListener#onGoAwayRead(org.glowroot.agent.it.harness.shaded.netty.channel.ChannelHandlerContext, int, long, org.glowroot.agent.it.harness.shaded.netty.buffer.ByteBuf)}
