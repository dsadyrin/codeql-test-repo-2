...
import org.glowroot.agent.it.harness.shaded.netty.handler.codec.http2.StreamByteDistributor.Writer;
import org.glowroot.agent.it.harness.shaded.netty.util.BooleanSupplier;
...
import static org.glowroot.agent.it.harness.shaded.netty.handler.codec.http2.Http2CodecUtil.DEFAULT_WINDOW_SIZE;
...
public class DefaultHttp2RemoteFlowController implements Http2RemoteFlowController {
    ...
    /**
     * The amount of bytes that can be supported by underlying {@link org.glowroot.agent.it.harness.shaded.netty.channel.Channel} without
     * queuing "too-much".
     */
