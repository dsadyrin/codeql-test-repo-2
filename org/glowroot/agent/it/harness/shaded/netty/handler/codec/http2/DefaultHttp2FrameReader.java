...
import org.glowroot.agent.it.harness.shaded.netty.handler.codec.http2.Http2FrameReader.Configuration;
...
import static org.glowroot.agent.it.harness.shaded.netty.handler.codec.http2.Http2CodecUtil.SETTINGS_INITIAL_WINDOW_SIZE;
import static org.glowroot.agent.it.harness.shaded.netty.handler.codec.http2.Http2CodecUtil.SETTINGS_MAX_FRAME_SIZE;
import static org.glowroot.agent.it.harness.shaded.netty.handler.codec.http2.Http2CodecUtil.SETTING_ENTRY_LENGTH;
import static org.glowroot.agent.it.harness.shaded.netty.handler.codec.http2.Http2CodecUtil.headerListSizeExceeded;
import static org.glowroot.agent.it.harness.shaded.netty.handler.codec.http2.Http2CodecUtil.isMaxFrameSizeValid;
import static org.glowroot.agent.it.harness.shaded.netty.handler.codec.http2.Http2CodecUtil.readUnsignedInt;
import static org.glowroot.agent.it.harness.shaded.netty.handler.codec.http2.Http2Error.FLOW_CONTROL_ERROR;
import static org.glowroot.agent.it.harness.shaded.netty.handler.codec.http2.Http2Error.FRAME_SIZE_ERROR;
import static org.glowroot.agent.it.harness.shaded.netty.handler.codec.http2.Http2Error.PROTOCOL_ERROR;
import static org.glowroot.agent.it.harness.shaded.netty.handler.codec.http2.Http2Exception.connectionError;
import static org.glowroot.agent.it.harness.shaded.netty.handler.codec.http2.Http2Exception.streamError;
