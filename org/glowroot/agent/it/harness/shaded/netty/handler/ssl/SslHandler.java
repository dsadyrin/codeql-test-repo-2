 ...
 * under the License.
 */
package org.glowroot.agent.it.harness.shaded.netty.handler.ssl;
...
import org.glowroot.agent.it.harness.shaded.netty.buffer.CompositeByteBuf;
...
import org.glowroot.agent.it.harness.shaded.netty.channel.ChannelConfig;
import org.glowroot.agent.it.harness.shaded.netty.channel.ChannelException;
...
import org.glowroot.agent.it.harness.shaded.netty.channel.ChannelPromiseNotifier;
import org.glowroot.agent.it.harness.shaded.netty.channel.PendingWriteQueue;
import org.glowroot.agent.it.harness.shaded.netty.handler.codec.ByteToMessageDecoder;
import org.glowroot.agent.it.harness.shaded.netty.handler.codec.UnsupportedMessageTypeException;
import org.glowroot.agent.it.harness.shaded.netty.util.concurrent.DefaultPromise;
import org.glowroot.agent.it.harness.shaded.netty.util.concurrent.EventExecutor;
import org.glowroot.agent.it.harness.shaded.netty.util.concurrent.Future;
import org.glowroot.agent.it.harness.shaded.netty.util.concurrent.FutureListener;
import org.glowroot.agent.it.harness.shaded.netty.util.concurrent.ImmediateExecutor;
...
import org.glowroot.agent.it.harness.shaded.netty.util.internal.ThrowableUtil;
...
import static org.glowroot.agent.it.harness.shaded.netty.handler.ssl.SslUtils.getEncryptedPacketLength;
    ...
    private boolean ignoreException(Throwable t) {
        if (!(t instanceof SSLException) && t instanceof IOException && sslClosePromise.isDone()) {
            ...
            for (StackTraceElement element: elements) {
                ...
                // skip all classes that belong to the org.glowroot.agent.it.harness.shaded.netty package
                if (classname.startsWith("org.glowroot.agent.it.harness.shaded.netty.")) {
                    continue;
                }
