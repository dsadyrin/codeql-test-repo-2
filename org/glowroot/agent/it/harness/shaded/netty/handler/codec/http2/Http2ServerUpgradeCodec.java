...
import org.glowroot.agent.it.harness.shaded.netty.handler.codec.base64.Base64;
...
import org.glowroot.agent.it.harness.shaded.netty.handler.codec.http.HttpServerUpgradeHandler;
...
import static org.glowroot.agent.it.harness.shaded.netty.handler.codec.base64.Base64Dialect.URL_SAFE;
import static org.glowroot.agent.it.harness.shaded.netty.handler.codec.http2.Http2CodecUtil.FRAME_HEADER_LENGTH;
import static org.glowroot.agent.it.harness.shaded.netty.handler.codec.http2.Http2CodecUtil.HTTP_UPGRADE_SETTINGS_HEADER;
import static org.glowroot.agent.it.harness.shaded.netty.handler.codec.http2.Http2CodecUtil.writeFrameHeader;
