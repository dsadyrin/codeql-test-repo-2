...
import static org.glowroot.agent.it.harness.shaded.netty.handler.codec.spdy.SpdyCodecUtil.SPDY_DATA_FLAG_FIN;
import static org.glowroot.agent.it.harness.shaded.netty.handler.codec.spdy.SpdyCodecUtil.SPDY_DATA_FRAME;
import static org.glowroot.agent.it.harness.shaded.netty.handler.codec.spdy.SpdyCodecUtil.SPDY_FLAG_FIN;
import static org.glowroot.agent.it.harness.shaded.netty.handler.codec.spdy.SpdyCodecUtil.SPDY_FLAG_UNIDIRECTIONAL;
import static org.glowroot.agent.it.harness.shaded.netty.handler.codec.spdy.SpdyCodecUtil.SPDY_GOAWAY_FRAME;
import static org.glowroot.agent.it.harness.shaded.netty.handler.codec.spdy.SpdyCodecUtil.SPDY_HEADERS_FRAME;
import static org.glowroot.agent.it.harness.shaded.netty.handler.codec.spdy.SpdyCodecUtil.SPDY_HEADER_FLAGS_OFFSET;
import static org.glowroot.agent.it.harness.shaded.netty.handler.codec.spdy.SpdyCodecUtil.SPDY_HEADER_LENGTH_OFFSET;
import static org.glowroot.agent.it.harness.shaded.netty.handler.codec.spdy.SpdyCodecUtil.SPDY_HEADER_SIZE;
import static org.glowroot.agent.it.harness.shaded.netty.handler.codec.spdy.SpdyCodecUtil.SPDY_HEADER_TYPE_OFFSET;
import static org.glowroot.agent.it.harness.shaded.netty.handler.codec.spdy.SpdyCodecUtil.SPDY_PING_FRAME;
import static org.glowroot.agent.it.harness.shaded.netty.handler.codec.spdy.SpdyCodecUtil.SPDY_RST_STREAM_FRAME;
import static org.glowroot.agent.it.harness.shaded.netty.handler.codec.spdy.SpdyCodecUtil.SPDY_SETTINGS_CLEAR;
import static org.glowroot.agent.it.harness.shaded.netty.handler.codec.spdy.SpdyCodecUtil.SPDY_SETTINGS_FRAME;
import static org.glowroot.agent.it.harness.shaded.netty.handler.codec.spdy.SpdyCodecUtil.SPDY_SETTINGS_PERSISTED;
import static org.glowroot.agent.it.harness.shaded.netty.handler.codec.spdy.SpdyCodecUtil.SPDY_SETTINGS_PERSIST_VALUE;
import static org.glowroot.agent.it.harness.shaded.netty.handler.codec.spdy.SpdyCodecUtil.SPDY_SYN_REPLY_FRAME;
import static org.glowroot.agent.it.harness.shaded.netty.handler.codec.spdy.SpdyCodecUtil.SPDY_SYN_STREAM_FRAME;
import static org.glowroot.agent.it.harness.shaded.netty.handler.codec.spdy.SpdyCodecUtil.SPDY_WINDOW_UPDATE_FRAME;
import static org.glowroot.agent.it.harness.shaded.netty.handler.codec.spdy.SpdyCodecUtil.getSignedInt;
import static org.glowroot.agent.it.harness.shaded.netty.handler.codec.spdy.SpdyCodecUtil.getUnsignedInt;
import static org.glowroot.agent.it.harness.shaded.netty.handler.codec.spdy.SpdyCodecUtil.getUnsignedMedium;
import static org.glowroot.agent.it.harness.shaded.netty.handler.codec.spdy.SpdyCodecUtil.getUnsignedShort;
