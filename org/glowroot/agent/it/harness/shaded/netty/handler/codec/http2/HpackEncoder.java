...
import org.glowroot.agent.it.harness.shaded.netty.handler.codec.http2.HpackUtil.IndexType;
...
import static org.glowroot.agent.it.harness.shaded.netty.handler.codec.http2.HpackUtil.equalsConstantTime;
import static org.glowroot.agent.it.harness.shaded.netty.handler.codec.http2.Http2CodecUtil.DEFAULT_HEADER_LIST_SIZE;
import static org.glowroot.agent.it.harness.shaded.netty.handler.codec.http2.Http2CodecUtil.DEFAULT_HEADER_TABLE_SIZE;
...
import static org.glowroot.agent.it.harness.shaded.netty.util.internal.MathUtil.findNextPositivePowerOfTwo;
