...
import org.glowroot.agent.it.harness.shaded.netty.handler.ssl.util.SelfSignedCertificate;
...
import org.glowroot.agent.it.harness.shaded.netty.util.internal.NativeLibraryLoader;
...
import org.glowroot.agent.it.harness.shaded.netty.internal.tcnative.Library;
...
public final class OpenSsl {
    ...
    static {
        ...
        try {
            Class.forName("org.glowroot.agent.it.harness.shaded.netty.internal.tcnative.SSL", false, OpenSsl.class.getClassLoader());
                                ...
                                useKeyManagerFactory = AccessController.doPrivileged(new PrivilegedAction<Boolean>() {
                                    ...
                                    public Boolean run() {
                                        return SystemPropertyUtil.getBoolean(
                                                "org.glowroot.agent.it.harness.shaded.netty.handler.ssl.openssl.useKeyManagerFactory", true);
                                    }
                                });
                            } catch (Throwable ignore) {
