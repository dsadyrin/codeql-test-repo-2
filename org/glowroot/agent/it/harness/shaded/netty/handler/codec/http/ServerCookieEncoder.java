...
import org.glowroot.agent.it.harness.shaded.netty.handler.codec.http.cookie.ServerCookieDecoder;
 ...
 *
 * @deprecated Use {@link org.glowroot.agent.it.harness.shaded.netty.handler.codec.http.cookie.ServerCookieEncoder} instead
 */
@Deprecated
public final class ServerCookieEncoder {
    ...
    public static String encode(String name, String value) {
        return org.glowroot.agent.it.harness.shaded.netty.handler.codec.http.cookie.ServerCookieEncoder.LAX.encode(name, value);
    }
    ...
    public static String encode(Cookie cookie) {
        return org.glowroot.agent.it.harness.shaded.netty.handler.codec.http.cookie.ServerCookieEncoder.LAX.encode(cookie);
    }
    ...
    public static List<String> encode(Cookie... cookies) {
        return org.glowroot.agent.it.harness.shaded.netty.handler.codec.http.cookie.ServerCookieEncoder.LAX.encode(cookies);
    }
