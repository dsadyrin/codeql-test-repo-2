...
import org.glowroot.agent.it.harness.shaded.netty.handler.codec.http.cookie.ClientCookieDecoder;
...
public final class ClientCookieEncoder {
    ...
    public static String encode(String name, String value) {
        return org.glowroot.agent.it.harness.shaded.netty.handler.codec.http.cookie.ClientCookieEncoder.LAX.encode(name, value);
    }
    ...
    public static String encode(Cookie cookie) {
        return org.glowroot.agent.it.harness.shaded.netty.handler.codec.http.cookie.ClientCookieEncoder.LAX.encode(cookie);
    }
    ...
    public static String encode(Cookie... cookies) {
        return org.glowroot.agent.it.harness.shaded.netty.handler.codec.http.cookie.ClientCookieEncoder.LAX.encode(cookies);
    }
