...
import org.glowroot.agent.it.harness.shaded.netty.handler.codec.http.DefaultFullHttpRequest;
import org.glowroot.agent.it.harness.shaded.netty.handler.codec.http.DefaultFullHttpResponse;
import org.glowroot.agent.it.harness.shaded.netty.handler.codec.http.DefaultHttpRequest;
import org.glowroot.agent.it.harness.shaded.netty.handler.codec.http.FullHttpMessage;
import org.glowroot.agent.it.harness.shaded.netty.handler.codec.http.FullHttpRequest;
import org.glowroot.agent.it.harness.shaded.netty.handler.codec.http.FullHttpResponse;
import org.glowroot.agent.it.harness.shaded.netty.handler.codec.http.HttpHeaderNames;
import org.glowroot.agent.it.harness.shaded.netty.handler.codec.http.HttpHeaderValues;
import org.glowroot.agent.it.harness.shaded.netty.handler.codec.http.HttpHeaders;
import org.glowroot.agent.it.harness.shaded.netty.handler.codec.http.HttpMessage;
import org.glowroot.agent.it.harness.shaded.netty.handler.codec.http.HttpMethod;
import org.glowroot.agent.it.harness.shaded.netty.handler.codec.http.HttpRequest;
import org.glowroot.agent.it.harness.shaded.netty.handler.codec.http.HttpResponse;
import org.glowroot.agent.it.harness.shaded.netty.handler.codec.http.HttpResponseStatus;
import org.glowroot.agent.it.harness.shaded.netty.handler.codec.http.HttpUtil;
import org.glowroot.agent.it.harness.shaded.netty.handler.codec.http.HttpVersion;
...
import static org.glowroot.agent.it.harness.shaded.netty.handler.codec.http.HttpScheme.HTTP;
import static org.glowroot.agent.it.harness.shaded.netty.handler.codec.http.HttpScheme.HTTPS;
import static org.glowroot.agent.it.harness.shaded.netty.handler.codec.http.HttpUtil.isAsteriskForm;
import static org.glowroot.agent.it.harness.shaded.netty.handler.codec.http.HttpUtil.isOriginForm;
...
import static org.glowroot.agent.it.harness.shaded.netty.util.AsciiString.EMPTY_STRING;
import static org.glowroot.agent.it.harness.shaded.netty.util.ByteProcessor.FIND_SEMI_COLON;
import static org.glowroot.agent.it.harness.shaded.netty.util.internal.ObjectUtil.checkNotNull;
import static org.glowroot.agent.it.harness.shaded.netty.util.internal.StringUtil.isNullOrEmpty;
import static org.glowroot.agent.it.harness.shaded.netty.util.internal.StringUtil.length;
