 ...
 * under the License.
 */
package org.glowroot.agent.it.harness.shaded.netty.util.concurrent;

import org.glowroot.agent.it.harness.shaded.netty.util.Signal;
...
public class DefaultPromise<V> extends AbstractFuture<V> implements Promise<V> {
    ...
    private static final int MAX_LISTENER_STACK_DEPTH = Math.min(8,
            SystemPropertyUtil.getInt("org.glowroot.agent.it.harness.shaded.netty.defaultPromise.maxListenerStackDepth", 8));
