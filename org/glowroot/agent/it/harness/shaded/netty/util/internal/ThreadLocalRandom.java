 ...
 * tasks (for example, each a {@link org.glowroot.agent.it.harness.shaded.netty.util.internal.chmv8.ForkJoinTask}) use random numbers
...
public final class ThreadLocalRandom extends Random {
    ...
    static {
        initialSeedUniquifier = SystemPropertyUtil.getLong("org.glowroot.agent.it.harness.shaded.netty.initialSeedUniquifier", 0);
