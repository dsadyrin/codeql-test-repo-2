        ...
        DefaultResourceLeakDetectorFactory() {
            ...
            try {
                customLeakDetector = AccessController.doPrivileged(new PrivilegedAction<String>() {
                    @Override
                    public String run() {
                        return SystemPropertyUtil.get("org.glowroot.agent.it.harness.shaded.netty.customResourceLeakDetector");
                    }
                });
            } catch (Throwable cause) {
                logger.error("Could not access System property: org.glowroot.agent.it.harness.shaded.netty.customResourceLeakDetector", cause);
