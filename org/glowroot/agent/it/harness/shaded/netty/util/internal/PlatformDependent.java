...
import static org.glowroot.agent.it.harness.shaded.netty.util.internal.PlatformDependent0.HASH_CODE_ASCII_SEED;
import static org.glowroot.agent.it.harness.shaded.netty.util.internal.PlatformDependent0.HASH_CODE_C1;
import static org.glowroot.agent.it.harness.shaded.netty.util.internal.PlatformDependent0.HASH_CODE_C2;
import static org.glowroot.agent.it.harness.shaded.netty.util.internal.PlatformDependent0.hashCodeAsciiSanitize;
import static org.glowroot.agent.it.harness.shaded.netty.util.internal.PlatformDependent0.unalignedAccess;
 ...
 * the system property <strong>org.glowroot.agent.it.harness.shaded.netty.noUnsafe</strong>.
 */
public final class PlatformDependent {
    ...
    private static final boolean DIRECT_BUFFER_PREFERRED =
            HAS_UNSAFE && !SystemPropertyUtil.getBoolean("org.glowroot.agent.it.harness.shaded.netty.noPreferDirect", false);
    ...
    static {
        ...
        long maxDirectMemory = SystemPropertyUtil.getLong("org.glowroot.agent.it.harness.shaded.netty.maxDirectMemory", -1);
        ...
        int tryAllocateUninitializedArray =
                SystemPropertyUtil.getInt("org.glowroot.agent.it.harness.shaded.netty.uninitializedArrayAllocationThreshold", 1024);
    ...
    private static File tmpdir0() {
        File f;
        try {
            f = toDirectory(SystemPropertyUtil.get("org.glowroot.agent.it.harness.shaded.netty.tmpdir"));
            if (f != null) {
    ...
    private static int bitMode0() {
        ...
        int bitMode = SystemPropertyUtil.getInt("org.glowroot.agent.it.harness.shaded.netty.bitMode", 0);
        if (bitMode > 0) {
