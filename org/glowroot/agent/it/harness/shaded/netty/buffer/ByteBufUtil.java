...
import org.glowroot.agent.it.harness.shaded.netty.util.ByteProcessor;
import org.glowroot.agent.it.harness.shaded.netty.util.CharsetUtil;
import org.glowroot.agent.it.harness.shaded.netty.util.Recycler;
import org.glowroot.agent.it.harness.shaded.netty.util.Recycler.Handle;
...
import static org.glowroot.agent.it.harness.shaded.netty.util.internal.MathUtil.isOutOfBounds;
...
import static org.glowroot.agent.it.harness.shaded.netty.util.internal.StringUtil.isSurrogate;
...
public final class ByteBufUtil {
    ...
    static {
        String allocType = SystemPropertyUtil.get(
                "org.glowroot.agent.it.harness.shaded.netty.allocator.type", PlatformDependent.isAndroid() ? "unpooled" : "pooled");
        ...
        THREAD_LOCAL_BUFFER_SIZE = SystemPropertyUtil.getInt("org.glowroot.agent.it.harness.shaded.netty.threadLocalDirectBufferSize", 64 * 1024);
        logger.debug("-Dio.netty.threadLocalDirectBufferSize: {}", THREAD_LOCAL_BUFFER_SIZE);

        MAX_CHAR_BUFFER_SIZE = SystemPropertyUtil.getInt("org.glowroot.agent.it.harness.shaded.netty.maxThreadLocalCharBufferSize", 16 * 1024);
