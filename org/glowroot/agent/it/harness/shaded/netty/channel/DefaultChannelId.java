...
import org.glowroot.agent.it.harness.shaded.netty.util.internal.MacAddressUtil;
...
import static org.glowroot.agent.it.harness.shaded.netty.util.internal.MacAddressUtil.defaultMachineId;
import static org.glowroot.agent.it.harness.shaded.netty.util.internal.MacAddressUtil.parseMAC;
...
public final class DefaultChannelId implements ChannelId {
    ...
    static {
        int processId = -1;
        String customProcessId = SystemPropertyUtil.get("org.glowroot.agent.it.harness.shaded.netty.processId");
        ...
        byte[] machineId = null;
        String customMachineId = SystemPropertyUtil.get("org.glowroot.agent.it.harness.shaded.netty.machineId");
