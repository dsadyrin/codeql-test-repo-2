 ...
 * <ul>
 * <li>{@code org.glowroot.agent.it.harness.shaded.netty.machineId} - hexadecimal representation of 48 (or 64) bit integer,
 *     optionally separated by colon or hyphen.</li>
 * <li>{@code org.glowroot.agent.it.harness.shaded.netty.processId} - an integer between 0 and 65535</li>
 * </ul>
 * </p>
 */
