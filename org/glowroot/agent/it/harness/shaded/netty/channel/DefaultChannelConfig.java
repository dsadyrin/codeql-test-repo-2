...
import static org.glowroot.agent.it.harness.shaded.netty.channel.ChannelOption.ALLOCATOR;
import static org.glowroot.agent.it.harness.shaded.netty.channel.ChannelOption.AUTO_CLOSE;
import static org.glowroot.agent.it.harness.shaded.netty.channel.ChannelOption.AUTO_READ;
import static org.glowroot.agent.it.harness.shaded.netty.channel.ChannelOption.CONNECT_TIMEOUT_MILLIS;
import static org.glowroot.agent.it.harness.shaded.netty.channel.ChannelOption.MAX_MESSAGES_PER_READ;
import static org.glowroot.agent.it.harness.shaded.netty.channel.ChannelOption.MESSAGE_SIZE_ESTIMATOR;
import static org.glowroot.agent.it.harness.shaded.netty.channel.ChannelOption.RCVBUF_ALLOCATOR;
import static org.glowroot.agent.it.harness.shaded.netty.channel.ChannelOption.SINGLE_EVENTEXECUTOR_PER_GROUP;
import static org.glowroot.agent.it.harness.shaded.netty.channel.ChannelOption.WRITE_BUFFER_HIGH_WATER_MARK;
import static org.glowroot.agent.it.harness.shaded.netty.channel.ChannelOption.WRITE_BUFFER_LOW_WATER_MARK;
import static org.glowroot.agent.it.harness.shaded.netty.channel.ChannelOption.WRITE_BUFFER_WATER_MARK;
import static org.glowroot.agent.it.harness.shaded.netty.channel.ChannelOption.WRITE_SPIN_COUNT;
