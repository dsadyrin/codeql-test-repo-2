...
package org.glowroot.agent.it.harness.shaded.google.instrumentation.common;

/**
 * Used to specify matching functions for use encoding tagged unions (i.e. sum types) in Java. See
 * {@link org.glowroot.agent.it.harness.shaded.google.instrumentation.stats.ViewDescriptor} for an example of it's use.
 *
