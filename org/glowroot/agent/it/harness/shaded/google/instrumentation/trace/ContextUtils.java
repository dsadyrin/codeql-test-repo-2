...
/**
 * Util methods/functionality to interact with the {@link org.glowroot.agent.it.harness.shaded.grpc.Context}.
 *
...
public final class ContextUtils {
  /** The {@link org.glowroot.agent.it.harness.shaded.grpc.Context.Key} used to interact with {@link org.glowroot.agent.it.harness.shaded.grpc.Context}. */
  ...
  private static final class WithSpan implements NonThrowingCloseable {
     ...
     *
     * @param span is the {@code Span} to be added to the current {@code org.glowroot.agent.it.harness.shaded.grpc.Context}.
