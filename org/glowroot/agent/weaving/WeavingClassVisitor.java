...
import org.glowroot.agent.shaded.objectweb.asm.FieldVisitor;
...
import org.glowroot.agent.shaded.objectweb.asm.commons.AdviceAdapter;
import org.glowroot.agent.shaded.objectweb.asm.commons.GeneratorAdapter;
import org.glowroot.agent.shaded.objectweb.asm.commons.Method;
import org.glowroot.agent.shaded.objectweb.asm.commons.MethodRemapper;
import org.glowroot.agent.shaded.objectweb.asm.commons.SimpleRemapper;
import org.glowroot.agent.shaded.objectweb.asm.signature.SignatureReader;
import org.glowroot.agent.shaded.objectweb.asm.signature.SignatureVisitor;
import org.glowroot.agent.shaded.objectweb.asm.tree.ClassNode;
import org.glowroot.agent.shaded.objectweb.asm.tree.FieldNode;
import org.glowroot.agent.shaded.objectweb.asm.tree.MethodNode;
...
import static org.glowroot.agent.shaded.objectweb.asm.Opcodes.AASTORE;
import static org.glowroot.agent.shaded.objectweb.asm.Opcodes.ACC_FINAL;
import static org.glowroot.agent.shaded.objectweb.asm.Opcodes.ACC_PUBLIC;
import static org.glowroot.agent.shaded.objectweb.asm.Opcodes.ACC_STATIC;
import static org.glowroot.agent.shaded.objectweb.asm.Opcodes.ACC_SUPER;
import static org.glowroot.agent.shaded.objectweb.asm.Opcodes.ACC_SYNTHETIC;
import static org.glowroot.agent.shaded.objectweb.asm.Opcodes.ALOAD;
import static org.glowroot.agent.shaded.objectweb.asm.Opcodes.ANEWARRAY;
import static org.glowroot.agent.shaded.objectweb.asm.Opcodes.ASM5;
import static org.glowroot.agent.shaded.objectweb.asm.Opcodes.ASTORE;
import static org.glowroot.agent.shaded.objectweb.asm.Opcodes.ATHROW;
import static org.glowroot.agent.shaded.objectweb.asm.Opcodes.DUP;
import static org.glowroot.agent.shaded.objectweb.asm.Opcodes.F_SAME;
import static org.glowroot.agent.shaded.objectweb.asm.Opcodes.F_SAME1;
import static org.glowroot.agent.shaded.objectweb.asm.Opcodes.GETSTATIC;
import static org.glowroot.agent.shaded.objectweb.asm.Opcodes.GOTO;
import static org.glowroot.agent.shaded.objectweb.asm.Opcodes.ICONST_0;
import static org.glowroot.agent.shaded.objectweb.asm.Opcodes.ILOAD;
import static org.glowroot.agent.shaded.objectweb.asm.Opcodes.INVOKESPECIAL;
import static org.glowroot.agent.shaded.objectweb.asm.Opcodes.INVOKESTATIC;
import static org.glowroot.agent.shaded.objectweb.asm.Opcodes.INVOKEVIRTUAL;
import static org.glowroot.agent.shaded.objectweb.asm.Opcodes.IRETURN;
import static org.glowroot.agent.shaded.objectweb.asm.Opcodes.NEW;
import static org.glowroot.agent.shaded.objectweb.asm.Opcodes.PUTSTATIC;
import static org.glowroot.agent.shaded.objectweb.asm.Opcodes.RETURN;
import static org.glowroot.agent.shaded.objectweb.asm.Opcodes.V1_5;
