...
import org.glowroot.agent.shaded.glowroot.wire.api.model.AgentConfigOuterClass.AgentConfig.InstrumentationConfig.CaptureKind;
...
import static org.glowroot.agent.shaded.objectweb.asm.Opcodes.ACC_PRIVATE;
...
import static org.glowroot.agent.shaded.objectweb.asm.Opcodes.ACONST_NULL;
import static org.glowroot.agent.shaded.objectweb.asm.Opcodes.ALOAD;
import static org.glowroot.agent.shaded.objectweb.asm.Opcodes.ARETURN;
import static org.glowroot.agent.shaded.objectweb.asm.Opcodes.CHECKCAST;
import static org.glowroot.agent.shaded.objectweb.asm.Opcodes.GETFIELD;
...
import static org.glowroot.agent.shaded.objectweb.asm.Opcodes.IFEQ;
import static org.glowroot.agent.shaded.objectweb.asm.Opcodes.IFNE;
import static org.glowroot.agent.shaded.objectweb.asm.Opcodes.IFNONNULL;
import static org.glowroot.agent.shaded.objectweb.asm.Opcodes.INSTANCEOF;
import static org.glowroot.agent.shaded.objectweb.asm.Opcodes.INVOKEINTERFACE;
...
import static org.glowroot.agent.shaded.objectweb.asm.Opcodes.PUTFIELD;
