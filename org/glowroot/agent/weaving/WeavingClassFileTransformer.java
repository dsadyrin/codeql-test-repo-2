...
public class WeavingClassFileTransformer implements ClassFileTransformer {
    ...
    private static boolean isGlowrootAgentClass(String className) {
        ...
        return className.startsWith("org.glowroot.agent.shaded.glowroot.common/")
                || className.startsWith("org.glowroot.agent.shaded.glowroot.ui/")
                || className.startsWith("org.glowroot.agent.shaded.glowroot.wire.api/")
