package org.glowroot.agent.shaded.fasterxml.jackson.databind.jsontype;

import org.glowroot.agent.shaded.fasterxml.jackson.annotation.JsonTypeInfo;
import org.glowroot.agent.shaded.fasterxml.jackson.databind.DatabindContext;
 ...
 * ({@link org.glowroot.agent.shaded.fasterxml.jackson.databind.jsontype.TypeSerializer},
 * {@link org.glowroot.agent.shaded.fasterxml.jackson.databind.jsontype.TypeDeserializer}) for converting
 ...
 * abstract base class {@link org.glowroot.agent.shaded.fasterxml.jackson.databind.jsontype.impl.TypeIdResolverBase}
...
public interface TypeIdResolver
{
     ...
     * 
     * @since 2.5 -- but since 2.3 has existed in {@link org.glowroot.agent.shaded.fasterxml.jackson.databind.jsontype.impl.TypeIdResolverBase}
     */
