...
import org.glowroot.agent.shaded.fasterxml.jackson.databind.deser.BeanDeserializerFactory;
import org.glowroot.agent.shaded.fasterxml.jackson.databind.deser.SettableBeanProperty;
import org.glowroot.agent.shaded.fasterxml.jackson.databind.deser.impl.ObjectIdReader;
 ...
 * but instead extend {@link org.glowroot.agent.shaded.fasterxml.jackson.databind.deser.std.StdDeserializer}
 * (or its subtypes like {@link org.glowroot.agent.shaded.fasterxml.jackson.databind.deser.std.StdScalarDeserializer}).
 *<p>
 ...
 * to implement {@link org.glowroot.agent.shaded.fasterxml.jackson.databind.deser.ResolvableDeserializer},
 ...
 * to implement 
 * {@link org.glowroot.agent.shaded.fasterxml.jackson.databind.deser.ContextualDeserializer},
 * which allows specialization of deserializers: call to
 * {@link org.glowroot.agent.shaded.fasterxml.jackson.databind.deser.ContextualDeserializer#createContextual}
 * is passed information on property, and can create a newly configured
 * deserializer for handling that particular property.
 *<p>
 * If both
 * {@link org.glowroot.agent.shaded.fasterxml.jackson.databind.deser.ResolvableDeserializer} and
 * {@link org.glowroot.agent.shaded.fasterxml.jackson.databind.deser.ContextualDeserializer}
...
public abstract class JsonDeserializer<T>
{
     ...
     * if instance implements {@link org.glowroot.agent.shaded.fasterxml.jackson.databind.deser.ResolvableDeserializer}:
     ...
     * {@link org.glowroot.agent.shaded.fasterxml.jackson.databind.deser.BeanDeserializer})
     ...
     * annotation {@link org.glowroot.agent.shaded.fasterxml.jackson.databind.annotation.JsonDeserialize}
     */
