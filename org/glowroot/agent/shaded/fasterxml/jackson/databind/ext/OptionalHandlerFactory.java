package org.glowroot.agent.shaded.fasterxml.jackson.databind.ext;
...
public class OptionalHandlerFactory implements java.io.Serializable
{
    ...
    private final static String SERIALIZERS_FOR_JAVAX_XML = "org.glowroot.agent.shaded.fasterxml.jackson.databind.ext.CoreXMLSerializers";
    private final static String DESERIALIZERS_FOR_JAVAX_XML = "org.glowroot.agent.shaded.fasterxml.jackson.databind.ext.CoreXMLDeserializers";
    ...
    private final static String SERIALIZER_FOR_DOM_NODE = "org.glowroot.agent.shaded.fasterxml.jackson.databind.ext.DOMSerializer";
    private final static String DESERIALIZER_FOR_DOM_DOCUMENT = "org.glowroot.agent.shaded.fasterxml.jackson.databind.ext.DOMDeserializer$DocumentDeserializer";
    private final static String DESERIALIZER_FOR_DOM_NODE = "org.glowroot.agent.shaded.fasterxml.jackson.databind.ext.DOMDeserializer$NodeDeserializer";
