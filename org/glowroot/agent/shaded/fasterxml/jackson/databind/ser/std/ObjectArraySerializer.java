...
import org.glowroot.agent.shaded.fasterxml.jackson.databind.ser.ContainerSerializer;
import org.glowroot.agent.shaded.fasterxml.jackson.databind.ser.ContextualSerializer;
import org.glowroot.agent.shaded.fasterxml.jackson.databind.ser.impl.PropertySerializerMap;
import org.glowroot.agent.shaded.fasterxml.jackson.databind.type.ArrayType;
        ...
        if (typeHint != null) {
            ...
            if (javaType.isArrayType()) {
                ...
                if (componentType == Object.class) {
                    o.set("items", org.glowroot.agent.shaded.fasterxml.jackson.databind.jsonschema.JsonSchema.getDefaultSchemaNode());
                } else {
                    JsonSerializer<Object> ser = provider.findValueSerializer(componentType, _property);
                    JsonNode schemaNode = (ser instanceof SchemaAware) ?
                            ((SchemaAware) ser).getSchema(provider, null) :
                            	org.glowroot.agent.shaded.fasterxml.jackson.databind.jsonschema.JsonSchema.getDefaultSchemaNode();
