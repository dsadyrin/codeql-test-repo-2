...
import org.glowroot.agent.shaded.fasterxml.jackson.annotation.JsonFormat;
...
import org.glowroot.agent.shaded.fasterxml.jackson.databind.annotation.JsonSerialize;
import org.glowroot.agent.shaded.fasterxml.jackson.databind.cfg.SerializerFactoryConfig;
import org.glowroot.agent.shaded.fasterxml.jackson.databind.ext.OptionalHandlerFactory;
...
import org.glowroot.agent.shaded.fasterxml.jackson.databind.ser.impl.*;
import org.glowroot.agent.shaded.fasterxml.jackson.databind.ser.std.*;
import org.glowroot.agent.shaded.fasterxml.jackson.databind.type.*;
import org.glowroot.agent.shaded.fasterxml.jackson.databind.util.*;
    ...
    implements java.io.Serializable
{
     ...
     * {@link org.glowroot.agent.shaded.fasterxml.jackson.databind.ser.BeanSerializerFactory} for more details.
     */
     ...
     *  </li>
     * <li>If type has {@link org.glowroot.agent.shaded.fasterxml.jackson.annotation.JsonValue} annotation (or equivalent), build serializer
     ...
     * has an annotation
     * (@link org.glowroot.agent.shaded.fasterxml.jackson.databind.annotation.JsonSerialize#using)
