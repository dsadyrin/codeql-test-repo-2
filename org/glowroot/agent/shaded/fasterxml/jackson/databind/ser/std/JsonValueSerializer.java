...
import org.glowroot.agent.shaded.fasterxml.jackson.databind.ser.BeanSerializer;
import org.glowroot.agent.shaded.fasterxml.jackson.databind.ser.ContextualSerializer;

/**
 * Serializer class that can serialize Object that have a
 * {@link org.glowroot.agent.shaded.fasterxml.jackson.annotation.JsonValue} annotation to
    ...
    implements ContextualSerializer, JsonFormatVisitable, SchemaAware
{
     ...
     *    {@link org.glowroot.agent.shaded.fasterxml.jackson.databind.annotation.JsonSerialize#using}), otherwise
     *    null
     */
...
//            TypeSerializer typeSer = new TypeSerializerWrapper(typeSer0, bean);
        ...
        throws JsonMappingException
    {
        ...
        return org.glowroot.agent.shaded.fasterxml.jackson.databind.jsonschema.JsonSchema.getDefaultSchemaNode();
    }
