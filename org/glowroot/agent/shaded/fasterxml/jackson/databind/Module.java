...
import org.glowroot.agent.shaded.fasterxml.jackson.databind.deser.Deserializers;
import org.glowroot.agent.shaded.fasterxml.jackson.databind.deser.KeyDeserializers;
import org.glowroot.agent.shaded.fasterxml.jackson.databind.deser.ValueInstantiators;
import org.glowroot.agent.shaded.fasterxml.jackson.databind.introspect.ClassIntrospector;
import org.glowroot.agent.shaded.fasterxml.jackson.databind.jsontype.NamedType;
...
import org.glowroot.agent.shaded.fasterxml.jackson.databind.type.TypeModifier;
    ...
    implements Versioned
{
     ...
     * (see {@link org.glowroot.agent.shaded.fasterxml.jackson.databind.MapperFeature#IGNORE_DUPLICATE_MODULE_REGISTRATIONS})
    ...
    public static interface SetupContext
    {
        ...
        /**
         * Method that module can use to register additional
         * {@link TypeModifier} instance, which can augment {@link org.glowroot.agent.shaded.fasterxml.jackson.databind.JavaType}
         * instances constructed by {@link org.glowroot.agent.shaded.fasterxml.jackson.databind.type.TypeFactory}.
         * 
        ...
        /**
         * Method that module can use to register additional {@link org.glowroot.agent.shaded.fasterxml.jackson.databind.deser.ValueInstantiator}s,
         * by adding {@link ValueInstantiators} object that gets called when 
         * instantatiator is needed by a deserializer.
         * 
         * @param instantiators Object that can provide {@link org.glowroot.agent.shaded.fasterxml.jackson.databind.deser.ValueInstantiator}s for
