...
import org.glowroot.agent.shaded.fasterxml.jackson.annotation.ObjectIdGenerator;
...
import org.glowroot.agent.shaded.fasterxml.jackson.databind.deser.ContextualDeserializer;
...
import org.glowroot.agent.shaded.fasterxml.jackson.databind.ser.ContextualSerializer;
import org.glowroot.agent.shaded.fasterxml.jackson.databind.ser.FilterProvider;
import org.glowroot.agent.shaded.fasterxml.jackson.databind.ser.ResolvableSerializer;
import org.glowroot.agent.shaded.fasterxml.jackson.databind.ser.SerializerCache;
import org.glowroot.agent.shaded.fasterxml.jackson.databind.ser.SerializerFactory;
import org.glowroot.agent.shaded.fasterxml.jackson.databind.ser.impl.FailingSerializer;
import org.glowroot.agent.shaded.fasterxml.jackson.databind.ser.impl.ReadOnlyClassToSerializerMap;
import org.glowroot.agent.shaded.fasterxml.jackson.databind.ser.impl.TypeWrappedSerializer;
import org.glowroot.agent.shaded.fasterxml.jackson.databind.ser.impl.UnknownSerializer;
import org.glowroot.agent.shaded.fasterxml.jackson.databind.ser.impl.WritableObjectId;
import org.glowroot.agent.shaded.fasterxml.jackson.databind.ser.std.NullSerializer;
import org.glowroot.agent.shaded.fasterxml.jackson.databind.type.TypeFactory;
import org.glowroot.agent.shaded.fasterxml.jackson.databind.util.ClassUtil;
 ...
 * {@link org.glowroot.agent.shaded.fasterxml.jackson.databind.ser.DefaultSerializerProvider}.
    ...
    extends DatabindContext
{
     ...
     * although alternatively {@link org.glowroot.agent.shaded.fasterxml.jackson.databind.ser.std.ToStringSerializer}
     ...
     * (via {@link org.glowroot.agent.shaded.fasterxml.jackson.databind.ser.ResolvableSerializer}) and/or contextualized
     * (via {@link org.glowroot.agent.shaded.fasterxml.jackson.databind.ser.ContextualSerializer}) as necessary.
     * 
