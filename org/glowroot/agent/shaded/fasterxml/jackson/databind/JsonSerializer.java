...
import org.glowroot.agent.shaded.fasterxml.jackson.databind.util.EmptyIterator;
 ...
 * {@link org.glowroot.agent.shaded.fasterxml.jackson.databind.ser.std.StdSerializer} instead
 ...
 * to implement {@link org.glowroot.agent.shaded.fasterxml.jackson.databind.ser.ResolvableSerializer},
 ...
 * to implement 
 * {@link org.glowroot.agent.shaded.fasterxml.jackson.databind.ser.ContextualSerializer},
 * which allows specialization of serializers: call to
 * {@link org.glowroot.agent.shaded.fasterxml.jackson.databind.ser.ContextualSerializer#createContextual}
 * is passed information on property, and can create a newly configured
 * serializer for handling that particular property.
 *<p>
 * If both
 * {@link org.glowroot.agent.shaded.fasterxml.jackson.databind.ser.ResolvableSerializer} and
 * {@link org.glowroot.agent.shaded.fasterxml.jackson.databind.ser.ContextualSerializer}
    ...
    implements JsonFormatVisitable // since 2.1
{
     ...
     * {@link org.glowroot.agent.shaded.fasterxml.jackson.databind.ser.BeanPropertyWriter}.
     * Of standard Jackson serializers, only {@link org.glowroot.agent.shaded.fasterxml.jackson.databind.ser.BeanSerializer}
     * exposes properties.
     *
     * @since 2.6
     */
     ...
     * annotation {@link org.glowroot.agent.shaded.fasterxml.jackson.databind.annotation.JsonSerialize}.
     */
