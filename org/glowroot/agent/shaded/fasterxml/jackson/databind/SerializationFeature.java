...
import org.glowroot.agent.shaded.fasterxml.jackson.databind.cfg.ConfigFeature;
...
public enum SerializationFeature implements ConfigFeature
{
     ...
     * no explicit {@link org.glowroot.agent.shaded.fasterxml.jackson.core.PrettyPrinter} has been configured
     ...
     * in conjunction with {@link org.glowroot.agent.shaded.fasterxml.jackson.annotation.JsonUnwrapped}.
     ...
     * {@link org.glowroot.agent.shaded.fasterxml.jackson.databind.SerializationConfig#getDateFormat}:
     * the default setting being {@link org.glowroot.agent.shaded.fasterxml.jackson.databind.util.StdDateFormat},
     ...
     * {@link org.glowroot.agent.shaded.fasterxml.jackson.core.JsonGenerator#writeNumber(String)}
     * ot may cause compatibility problems since not all {@link org.glowroot.agent.shaded.fasterxml.jackson.core.JsonGenerator}
     * implementations support such mode of output: usually only text-based formats
     * support it.
     *<p>
     * Feature is disabled by default.
     * 
     * @deprecated Since 2.5: use {@link org.glowroot.agent.shaded.fasterxml.jackson.core.JsonGenerator.Feature#WRITE_BIGDECIMAL_AS_PLAIN} directly
     *    (using {@link ObjectWriter#with(org.glowroot.agent.shaded.fasterxml.jackson.core.JsonGenerator.Feature)}).
     */
