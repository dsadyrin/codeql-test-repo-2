package org.glowroot.agent.shaded.fasterxml.jackson.databind.module;
    ...
    public void addSerializer(JsonSerializer<?> ser)
    {
        ...
        if (cls == null || cls == Object.class) {
            throw new IllegalArgumentException("JsonSerializer of type "+ser.getClass().getName()
                    ...
                    +" or make serializer extend 'org.glowroot.agent.shaded.fasterxml.jackson.databind.ser.std.StdSerializer'"); 
        }
