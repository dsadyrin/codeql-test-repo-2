package org.glowroot.agent.shaded.fasterxml.jackson.databind;
...
import org.glowroot.agent.shaded.fasterxml.jackson.annotation.*;
import org.glowroot.agent.shaded.fasterxml.jackson.core.*;
import org.glowroot.agent.shaded.fasterxml.jackson.core.io.CharacterEscapes;
import org.glowroot.agent.shaded.fasterxml.jackson.core.io.SegmentedStringWriter;
import org.glowroot.agent.shaded.fasterxml.jackson.core.type.ResolvedType;
import org.glowroot.agent.shaded.fasterxml.jackson.core.type.TypeReference;
import org.glowroot.agent.shaded.fasterxml.jackson.core.util.*;
import org.glowroot.agent.shaded.fasterxml.jackson.databind.cfg.BaseSettings;
import org.glowroot.agent.shaded.fasterxml.jackson.databind.cfg.ContextAttributes;
import org.glowroot.agent.shaded.fasterxml.jackson.databind.cfg.HandlerInstantiator;
import org.glowroot.agent.shaded.fasterxml.jackson.databind.cfg.MapperConfig;
import org.glowroot.agent.shaded.fasterxml.jackson.databind.deser.*;
import org.glowroot.agent.shaded.fasterxml.jackson.databind.introspect.*;
import org.glowroot.agent.shaded.fasterxml.jackson.databind.jsonFormatVisitors.JsonFormatVisitorWrapper;
import org.glowroot.agent.shaded.fasterxml.jackson.databind.jsontype.*;
import org.glowroot.agent.shaded.fasterxml.jackson.databind.jsontype.impl.StdSubtypeResolver;
import org.glowroot.agent.shaded.fasterxml.jackson.databind.jsontype.impl.StdTypeResolverBuilder;
import org.glowroot.agent.shaded.fasterxml.jackson.databind.node.*;
import org.glowroot.agent.shaded.fasterxml.jackson.databind.ser.*;
import org.glowroot.agent.shaded.fasterxml.jackson.databind.type.*;
import org.glowroot.agent.shaded.fasterxml.jackson.databind.util.RootNameLookup;
import org.glowroot.agent.shaded.fasterxml.jackson.databind.util.StdDateFormat;
import org.glowroot.agent.shaded.fasterxml.jackson.databind.util.TokenBuffer;
...
<pre>
  ...
  // and find values by, for example, using a {@link org.glowroot.agent.shaded.fasterxml.jackson.core.JsonPointer} expression:
        ...
        java.io.Serializable // as of 2.1
{
    ...
    public Version version() {
        return org.glowroot.agent.shaded.fasterxml.jackson.databind.cfg.PackageVersion.VERSION;
    }
    ...
    */
     ...
     * have a look at {@link org.glowroot.agent.shaded.fasterxml.jackson.databind.introspect.AnnotationIntrospectorPair}.
     * 
     * @see org.glowroot.agent.shaded.fasterxml.jackson.databind.introspect.AnnotationIntrospectorPair
     */
     ...
     * have been annotated with {@link org.glowroot.agent.shaded.fasterxml.jackson.annotation.JsonTypeInfo}).
     *<P>
     ...
     * {@link org.glowroot.agent.shaded.fasterxml.jackson.annotation.JsonTypeInfo}) will have
    ...
    /**
     * Method for changing state of specified {@link org.glowroot.agent.shaded.fasterxml.jackson.core.JsonParser.Feature}s
    ...
    /**
     * Method for enabling specified {@link org.glowroot.agent.shaded.fasterxml.jackson.core.JsonParser.Feature}s
     * for parser instances this object mapper creates.
     *<p>
    ...
    /**
     * Method for disabling specified {@link org.glowroot.agent.shaded.fasterxml.jackson.core.JsonParser.Feature}s
     * for parser instances this object mapper creates.
     *<p>
     * Note that this is equivalent to directly calling same method on {@link #getFactory}.
     *
    ...
    /**
     * Method for enabling specified {@link org.glowroot.agent.shaded.fasterxml.jackson.core.JsonGenerator.Feature}s
     * for parser instances this object mapper creates.
     *<p>
     * Note that this is equivalent to directly calling same method on {@link #getFactory}.
     *
    ...
    /**
     * Method for disabling specified {@link org.glowroot.agent.shaded.fasterxml.jackson.core.JsonGenerator.Feature}s
     * for parser instances this object mapper creates.
     *<p>
     * Note that this is equivalent to directly calling same method on {@link #getFactory}.
     *
     ...
     * raw value ({@link org.glowroot.agent.shaded.fasterxml.jackson.databind.util.RawValue}) or basic
     ...
     *  {@link org.glowroot.agent.shaded.fasterxml.jackson.databind.node.ObjectNode}
...
//    	_setupClassLoaderForDeserialization(valueType);
     ...
     */
    @Deprecated
    public org.glowroot.agent.shaded.fasterxml.jackson.databind.jsonschema.JsonSchema generateJsonSchema(Class<?> t)
