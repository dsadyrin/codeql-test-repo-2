 ...
 */
package org.glowroot.agent.shaded.fasterxml.jackson.core;

import java.io.*;
import java.lang.ref.SoftReference;
import java.net.URL;

import org.glowroot.agent.shaded.fasterxml.jackson.core.format.InputAccessor;
import org.glowroot.agent.shaded.fasterxml.jackson.core.format.MatchStrength;
import org.glowroot.agent.shaded.fasterxml.jackson.core.io.*;
import org.glowroot.agent.shaded.fasterxml.jackson.core.json.*;
import org.glowroot.agent.shaded.fasterxml.jackson.core.sym.ByteQuadsCanonicalizer;
import org.glowroot.agent.shaded.fasterxml.jackson.core.sym.CharsToNameCanonicalizer;
import org.glowroot.agent.shaded.fasterxml.jackson.core.util.BufferRecycler;
        ...
        java.io.Serializable // since 2.1 (for Android, mostly)
{
     ...
     */
    @Deprecated
    protected final transient org.glowroot.agent.shaded.fasterxml.jackson.core.sym.BytesToNameCanonicalizer _rootByteSymbols
        = org.glowroot.agent.shaded.fasterxml.jackson.core.sym.BytesToNameCanonicalizer.createRoot();
     ...
     * a <code>org.glowroot.agent.shaded.fasterxml.jackson.databind.ObjectMapper</code>)
     ...
     * if (and only if) {@link org.glowroot.agent.shaded.fasterxml.jackson.core.JsonParser.Feature#AUTO_CLOSE_SOURCE}
     * is enabled.
     *<p>
     ...
     * feature,
     * {@link org.glowroot.agent.shaded.fasterxml.jackson.core.JsonGenerator.Feature#AUTO_CLOSE_TARGET}
     * is enabled).
     ...
     * {@link JsonGenerator#close} is called (unless auto-closing
     * feature,
     * {@link org.glowroot.agent.shaded.fasterxml.jackson.core.JsonGenerator.Feature#AUTO_CLOSE_TARGET} is enabled).
