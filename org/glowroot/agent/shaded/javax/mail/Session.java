...
package org.glowroot.agent.shaded.javax.mail;
...
import org.glowroot.agent.shaded.sun.mail.util.LineInputStream;
import org.glowroot.agent.shaded.sun.mail.util.MailLogger;
 ...
 * file contents:
 * <pre>
 * protocol=imap; type=store; class=org.glowroot.agent.shaded.sun.mail.imap.IMAPStore; vendor=Oracle;
 * protocol=smtp; type=transport; class=org.glowroot.agent.shaded.sun.mail.smtp.SMTPTransport; vendor=Oracle;
 * </pre><p>
 *
 ...
 * <code>org.glowroot.agent.shaded.javax.mail.Address</code> returns the address type.  The
 ...
 * <code>org.glowroot.agent.shaded.javax.mail.Address</code> implementation that is present if it is
 * to be used.  For example, the
 * <code>org.glowroot.agent.shaded.javax.mail.internet.InternetAddress</code> method
...
public final class Session {
     ...
     * @see	org.glowroot.agent.shaded.javax.mail.Authenticator
     */
     ...
     * @see		org.glowroot.agent.shaded.javax.mail.URLName
     * @exception	NoSuchProviderException If a provider for the given
     ...
     * @return	A Transport object
     * @see org.glowroot.agent.shaded.javax.mail.Address
	...
	try {
	    Class<?>[] c = {org.glowroot.agent.shaded.javax.mail.Session.class, org.glowroot.agent.shaded.javax.mail.URLName.class};
	...
	if (providers.size() == 0) {
	    ...
	    addProvider(new Provider(Provider.Type.STORE,
			"imap", "org.glowroot.agent.shaded.sun.mail.imap.IMAPStore",
			"Oracle", Version.version));
	    addProvider(new Provider(Provider.Type.STORE,
			"imaps", "org.glowroot.agent.shaded.sun.mail.imap.IMAPSSLStore",
			"Oracle", Version.version));
	    addProvider(new Provider(Provider.Type.STORE,
			"pop3", "org.glowroot.agent.shaded.sun.mail.pop3.POP3Store",
			"Oracle", Version.version));
	    addProvider(new Provider(Provider.Type.STORE,
			"pop3s", "org.glowroot.agent.shaded.sun.mail.pop3.POP3SSLStore",
			"Oracle", Version.version));
	    addProvider(new Provider(Provider.Type.TRANSPORT,
			"smtp", "org.glowroot.agent.shaded.sun.mail.smtp.SMTPTransport",
			"Oracle", Version.version));
	    addProvider(new Provider(Provider.Type.TRANSPORT,
			"smtps", "org.glowroot.agent.shaded.sun.mail.smtp.SMTPSSLTransport",
			"Oracle", Version.version));
	}
