...
final class LogManagerProperties extends Properties {
    ...
    private static Properties readConfiguration() {
        ...
        try {
            String n = System.getProperty("org.glowroot.agent.jul.config.file");
            if (n != null) {
    ...
    /**
     * Determines if access to the {@code org.glowroot.agent.jul.LogManager} class is
     ...
     * argument constructor.
     * @since JavaMail 1.4.5
     * @see org.glowroot.agent.jul.LogRecord
     */
