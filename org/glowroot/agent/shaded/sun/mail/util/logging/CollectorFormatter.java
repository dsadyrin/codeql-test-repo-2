...
import org.glowroot.agent.jul.Handler;
import org.glowroot.agent.jul.LogRecord;
 ...
 * {@linkplain #getTail(org.glowroot.agent.jul.Handler) getTail} documentation.
...
public class CollectorFormatter extends Formatter {
     ...
     * <ol start='0'>
     * <li>{@code head} the
     * {@linkplain Formatter#getHead(org.glowroot.agent.jul.Handler) head} string
     ...
     * {@linkplain Formatter#format(org.glowroot.agent.jul.LogRecord) formatted} by
     ...
     * this {@linkplain #formatMessage(org.glowroot.agent.jul.LogRecord) formatter}.
     * <li>{@code tail} the
     * {@linkplain Formatter#getTail(org.glowroot.agent.jul.Handler) tail} string
     * returned from the target formatter and
     * {@linkplain #finish(java.lang.String) finished} by this formatter.
     ...
     * {@linkplain org.glowroot.agent.jul.LogRecord#getThrown throwable}.
     * <li>{@code normal messages} the count minus the thrown.
     * <li>{@code minMillis} the eldest log record
     * {@linkplain org.glowroot.agent.jul.LogRecord#getMillis event time}
     ...
     * <ul>
     * <li>{@code org.glowroot.agent.shaded.sun.mail.util.logging.CollectorFormatter.format={0}{1}{2}{4,choice,-1#|0#|0<... {4,number,integer} more}\n}
     * <p>
     ...
     * </pre>
     * <li>{@code org.glowroot.agent.shaded.sun.mail.util.logging.CollectorFormatter.format=These {3} messages occurred between\n{7,date,EEE, MMM dd HH:mm:ss:S ZZZ yyyy} and {8,time,EEE, MMM dd HH:mm:ss:S ZZZ yyyy}\n}
     * <p>
     ...
     * </pre>
     * <li>{@code org.glowroot.agent.shaded.sun.mail.util.logging.CollectorFormatter.format=These {3} messages occurred between {9,choice,86400000#{7,date} {7,time} and {8,time}|86400000<{7,date} and {8,date}}\n}
     * <p>
     ...
     * </pre>
     * <li>{@code org.glowroot.agent.shaded.sun.mail.util.logging.CollectorFormatter.format={13} alert reports since {10,date}.\n}
     * <p>
     ...
     * @see #getTail(org.glowroot.agent.jul.Handler)
     */
    @Override
