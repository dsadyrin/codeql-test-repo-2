...
package org.glowroot.agent.shaded.sun.mail.util.logging;

import static org.glowroot.agent.shaded.sun.mail.util.logging.LogManagerProperties.fromLogManager;
import java.io.*;
...
import java.util.*;
import org.glowroot.agent.jul.*;
import org.glowroot.agent.jul.Formatter;
import javax.activation.*;
import org.glowroot.agent.shaded.javax.mail.*;
import org.glowroot.agent.shaded.javax.mail.internet.*;
import org.glowroot.agent.shaded.javax.mail.util.ByteArrayDataSource;
 ...
 *      org.glowroot.agent.shaded.sun.mail.util.logging.MailHandler.mail.smtp.host = my-mail-server
 *      org.glowroot.agent.shaded.sun.mail.util.logging.MailHandler.mail.to = me@example.com
 *      org.glowroot.agent.shaded.sun.mail.util.logging.MailHandler.level = WARNING
 *      org.glowroot.agent.shaded.sun.mail.util.logging.MailHandler.verify = local
 * </pre>
 *
 ...
 * {@linkplain org.glowroot.agent.jul.Handler#getFilter() body} filter)
 *
 ...
 * (default is {@linkplain org.glowroot.agent.jul.Formatter#toString() toString}
 * of the attachment formatter)
 *
 * <li>&lt;handler-name&gt;.authenticator name of an
 * {@linkplain org.glowroot.agent.shaded.javax.mail.Authenticator} class used to provide login credentials
 ...
 * {@linkplain org.glowroot.agent.shaded.javax.mail.internet.MimeUtility#getDefaultJavaCharset() default}
 * platform encoding).
 *
 * <li>&lt;handler-name&gt;.errorManager name of an
 * <tt>ErrorManager</tt> class used to handle any configuration or mail
 * transport problems. (defaults to <tt>org.glowroot.agent.jul.ErrorManager</tt>)
 *
 ...
 * (defaults to <tt>org.glowroot.agent.jul.SimpleFormatter</tt>)
 *
 ...
 * (defaults to the {@linkplain org.glowroot.agent.shaded.javax.mail.Message#setFrom() local address})
 *
 ...
 * {@linkplain org.glowroot.agent.shaded.javax.mail.internet.InternetAddress#getLocalAddress
 * local address}.)
 *
 ...
 * with a {@linkplain org.glowroot.agent.jul.MemoryHandler} typically with an
 * equivalent capacity, level, and push level.
 *
 * <p>
 * <b>Error Handling:</b>
 * If the transport of an email message fails, the email is converted to
 * a {@linkplain org.glowroot.agent.shaded.javax.mail.internet.MimeMessage#writeTo raw}
 ...
 * store, {@linkplain org.glowroot.agent.shaded.javax.mail.internet.MimeMessage#MimeMessage(
 * org.glowroot.agent.shaded.javax.mail.Session, java.io.InputStream) reconstruct}, and resend the
   ...
   /**
    ...
    private String contentWithEncoding(String type, String encoding) {
        ...
        try {
            ...
            encoding = ct.toString(); //See org.glowroot.agent.shaded.javax.mail.internet.ContentType.
            if (!isEmpty(encoding)) {
                type = encoding;
            }
    ...
    /**
     * Factory method used to create a org.glowroot.agent.jul.SimpleFormatter.
