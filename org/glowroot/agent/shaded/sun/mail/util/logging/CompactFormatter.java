 ...
 */
public class CompactFormatter extends org.glowroot.agent.jul.Formatter {
    /**
     ...
     * {@linkplain #format(org.glowroot.agent.jul.LogRecord) format} method.
     */
     ...
     * <li>{@code level} - the
     * {@linkplain org.glowroot.agent.jul.Level#getLocalizedName log level}.</li>
     ...
     * <ul>
     * <li>{@code org.glowroot.agent.shaded.sun.mail.util.logging.CompactFormatter.format=%7$#.160s%n}
     * <p>
     ...
     * </pre>
     *
     * <li>{@code org.glowroot.agent.shaded.sun.mail.util.logging.CompactFormatter.format=%7$#.20s%n}
     * <p>
     ...
     * </pre>
     *
     * <li>{@code org.glowroot.agent.shaded.sun.mail.util.logging.CompactFormatter.format=%1$tc %2$s%n%4$s: %5$s%6$s%n}
     * <p>
     ...
     * </pre>
     *
     * <li>{@code org.glowroot.agent.shaded.sun.mail.util.logging.CompactFormatter.format=%4$s: %12$#.160s%n}
     * <p>
     ...
     * </pre>
     *
     * <li>{@code org.glowroot.agent.shaded.sun.mail.util.logging.CompactFormatter.format=[%9$d][%1$tT][%10$d][%2$s] %5$s%n%6$s%n}
     * <p>
     ...
     * @see #formatBackTrace(org.glowroot.agent.jul.LogRecord)
     */
     ...
     * @throws NullPointerException if the given record is null.
     * @see #apply(java.lang.Throwable)
     * @see #formatThrown(org.glowroot.agent.jul.LogRecord)
