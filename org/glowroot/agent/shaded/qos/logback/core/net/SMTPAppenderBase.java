 ...
 */
package org.glowroot.agent.shaded.qos.logback.core.net;
...
import org.glowroot.agent.shaded.javax.mail.Multipart;
import org.glowroot.agent.shaded.javax.mail.Session;
import org.glowroot.agent.shaded.javax.mail.Transport;
import org.glowroot.agent.shaded.javax.mail.internet.AddressException;
import org.glowroot.agent.shaded.javax.mail.internet.InternetAddress;
import org.glowroot.agent.shaded.javax.mail.internet.MimeBodyPart;
import org.glowroot.agent.shaded.javax.mail.internet.MimeMessage;
import org.glowroot.agent.shaded.javax.mail.internet.MimeMultipart;
import javax.naming.Context;
import javax.naming.InitialContext;

import org.glowroot.agent.shaded.qos.logback.core.AppenderBase;
import org.glowroot.agent.shaded.qos.logback.core.CoreConstants;
import org.glowroot.agent.shaded.qos.logback.core.Layout;
import org.glowroot.agent.shaded.qos.logback.core.boolex.EvaluationException;
import org.glowroot.agent.shaded.qos.logback.core.boolex.EventEvaluator;
import org.glowroot.agent.shaded.qos.logback.core.helpers.CyclicBuffer;
import org.glowroot.agent.shaded.qos.logback.core.pattern.PatternLayoutBase;
import org.glowroot.agent.shaded.qos.logback.core.sift.DefaultDiscriminator;
import org.glowroot.agent.shaded.qos.logback.core.sift.Discriminator;
import org.glowroot.agent.shaded.qos.logback.core.spi.CyclicBufferTracker;
import org.glowroot.agent.shaded.qos.logback.core.util.ContentTypeUtil;
import org.glowroot.agent.shaded.qos.logback.core.util.OptionHelper;
...
public abstract class SMTPAppenderBase<E> extends AppenderBase<E> {
    ...
    public void start() {
        ...
        if (session == null) {
            addError("Failed to obtain org.glowroot.agent.shaded.javax.mail.Session. Cannot start.");
            return;
        }
    ...
    private Session lookupSessionInJNDI() {
        addInfo("Looking up org.glowroot.agent.shaded.javax.mail.Session at JNDI location [" + jndiLocation + "]");
        try {
            Context initialContext = new InitialContext();
            Object obj = initialContext.lookup(jndiLocation);
            return (Session) obj;
        } catch (Exception e) {
            addError("Failed to obtain org.glowroot.agent.shaded.javax.mail.Session from JNDI location [" + jndiLocation + "]");
            return null;
        }
    }
    ...
    /**
     * Set the location where a {@link org.glowroot.agent.shaded.javax.mail.Session} resource is located in JNDI. Default value is
    ...
    /**
     * If set to true, a {@link org.glowroot.agent.shaded.javax.mail.Session} resource will be retrieved from JNDI. Default is false.
     *
     * @param sessionViaJNDI whether to obtain a org.glowroot.agent.shaded.javax.mail.Session by JNDI
     * @since 1.0.6
     */
