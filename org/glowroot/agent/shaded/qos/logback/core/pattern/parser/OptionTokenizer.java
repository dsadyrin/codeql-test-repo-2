 ...
 */
package org.glowroot.agent.shaded.qos.logback.core.pattern.parser;

import java.util.ArrayList;
import java.util.List;

import org.glowroot.agent.shaded.qos.logback.core.pattern.util.AsIsEscapeUtil;
import org.glowroot.agent.shaded.qos.logback.core.pattern.util.IEscapeUtil;

import static org.glowroot.agent.shaded.qos.logback.core.CoreConstants.CURLY_RIGHT;

import static org.glowroot.agent.shaded.qos.logback.core.CoreConstants.ESCAPE_CHAR;
import static org.glowroot.agent.shaded.qos.logback.core.CoreConstants.COMMA_CHAR;
import static org.glowroot.agent.shaded.qos.logback.core.CoreConstants.SINGLE_QUOTE_CHAR;
import static org.glowroot.agent.shaded.qos.logback.core.CoreConstants.DOUBLE_QUOTE_CHAR;

import org.glowroot.agent.shaded.qos.logback.core.pattern.parser.TokenStream.TokenizerState;
import org.glowroot.agent.shaded.qos.logback.core.spi.ScanException;
