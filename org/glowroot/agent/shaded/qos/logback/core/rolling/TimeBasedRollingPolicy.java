 ...
 */
package org.glowroot.agent.shaded.qos.logback.core.rolling;

import static org.glowroot.agent.shaded.qos.logback.core.CoreConstants.UNBOUND_HISTORY;
import static org.glowroot.agent.shaded.qos.logback.core.CoreConstants.UNBOUNDED_TOTAL_SIZE_CAP;
...
import org.glowroot.agent.shaded.qos.logback.core.rolling.helper.ArchiveRemover;
import org.glowroot.agent.shaded.qos.logback.core.rolling.helper.CompressionMode;
import org.glowroot.agent.shaded.qos.logback.core.rolling.helper.Compressor;
import org.glowroot.agent.shaded.qos.logback.core.rolling.helper.FileFilterUtil;
import org.glowroot.agent.shaded.qos.logback.core.rolling.helper.FileNamePattern;
import org.glowroot.agent.shaded.qos.logback.core.rolling.helper.RenameUtil;
