...
import org.glowroot.agent.shaded.qos.logback.core.net.ssl.ConfigurableSSLServerSocketFactory;
import org.glowroot.agent.shaded.qos.logback.core.net.ssl.SSLParametersConfiguration;

/**
 * A {@link SimpleSocketServer} that supports SSL.
 * 
 * <pre>
 *      &lt;b&gt;Usage:&lt;/b&gt; java org.glowroot.agent.shaded.qos.logback.classic.net.ssl.SimpleSSLSocketServer port configFile
 * </pre>
 * 
