 ...
 */
package org.glowroot.agent.shaded.qos.logback.classic.net;
...
import org.glowroot.agent.shaded.qos.logback.classic.pattern.SyslogStartConverter;
...
import org.glowroot.agent.shaded.qos.logback.classic.util.LevelToSyslogSeverity;
import org.glowroot.agent.shaded.qos.logback.core.CoreConstants;
import org.glowroot.agent.shaded.qos.logback.core.Layout;
import org.glowroot.agent.shaded.qos.logback.core.net.SyslogAppenderBase;
import org.glowroot.agent.shaded.qos.logback.core.net.SyslogOutputStream;
...
public class SyslogAppender extends SyslogAppenderBase<ILoggingEvent> {
     ...
     *
     * @see org.glowroot.agent.shaded.qos.logback.core.net.SyslogAppenderBase#getSeverityForEvent(java.lang.Object)
     */
    @Override
