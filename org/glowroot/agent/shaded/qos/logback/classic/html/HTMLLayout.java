 ...
 */
package org.glowroot.agent.shaded.qos.logback.classic.html;

import java.util.Map;

import org.glowroot.agent.shaded.qos.logback.classic.PatternLayout;
import org.glowroot.agent.shaded.qos.logback.classic.pattern.MDCConverter;
import org.glowroot.agent.shaded.qos.logback.classic.spi.ILoggingEvent;
import org.glowroot.agent.shaded.qos.logback.classic.html.DefaultCssBuilder;
import org.glowroot.agent.shaded.qos.logback.core.helpers.Transform;
import org.glowroot.agent.shaded.qos.logback.core.html.HTMLLayoutBase;
import org.glowroot.agent.shaded.qos.logback.core.html.IThrowableRenderer;
import org.glowroot.agent.shaded.qos.logback.core.pattern.Converter;
import static org.glowroot.agent.shaded.qos.logback.core.CoreConstants.LINE_SEPARATOR;
 ...
 * {@link org.glowroot.agent.shaded.qos.logback.classic.PatternLayout} for documentation on the
