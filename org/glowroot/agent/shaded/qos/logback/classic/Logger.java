...
import org.glowroot.agent.shaded.slf4j.spi.LocationAwareLogger;

import org.glowroot.agent.shaded.qos.logback.classic.spi.ILoggingEvent;
import org.glowroot.agent.shaded.qos.logback.classic.spi.LoggingEvent;
import org.glowroot.agent.shaded.qos.logback.classic.util.LoggerNameUtil;
...
import org.glowroot.agent.shaded.qos.logback.core.spi.AppenderAttachable;
import org.glowroot.agent.shaded.qos.logback.core.spi.AppenderAttachableImpl;
import org.glowroot.agent.shaded.qos.logback.core.spi.FilterReply;

public final class Logger implements org.glowroot.agent.shaded.slf4j.Logger, LocationAwareLogger, AppenderAttachable<ILoggingEvent>, Serializable {
     ...
     * information.
     */
    public static final String FQCN = org.glowroot.agent.shaded.qos.logback.classic.Logger.class.getName();
     ...
     * @param slf4jEvent
     */
    public void log(org.glowroot.agent.shaded.slf4j.event.LoggingEvent slf4jEvent) {
     ...
     * returned by org.glowroot.agent.shaded.slf4j.LoggerFactory.
     * 
