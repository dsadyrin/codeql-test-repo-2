 ...
 */
package org.glowroot.agent.shaded.qos.logback.classic.boolex;
...
import org.glowroot.agent.shaded.qos.logback.core.boolex.JaninoEventEvaluatorBase;
import org.glowroot.agent.shaded.qos.logback.core.boolex.Matcher;

public class JaninoEventEvaluator extends JaninoEventEvaluatorBase<ILoggingEvent> {

    public final static String IMPORT_LEVEL = "import org.glowroot.agent.shaded.qos.logback.classic.Level;\r\n";
