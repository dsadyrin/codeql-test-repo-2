...
import org.glowroot.agent.shaded.slf4j.MDC;
 ...
 *             class="org.glowroot.agent.shaded.qos.logback.core.ConsoleAppender"&gt;
 *     &lt;layout class="org.glowroot.agent.shaded.qos.logback.classic.PatternLayout"&gt;
 *       &lt;Pattern>TEST %d{HH:mm:ss.SSS} [%thread] %-5level %logger{36} - %msg%n&lt;/Pattern>
 *     &lt;/layout&gt;
 *   &lt;/appender&gt;
 *   
 *   &lt;turboFilter class=&quot;org.glowroot.agent.shaded.qos.logback.classic.turbo.DynamicThresholdFilter&quot;&gt;
 *     &lt;Key&gt;userId&lt;/Key&gt;
