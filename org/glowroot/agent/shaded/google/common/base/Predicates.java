 ...
 * <a href="https://github.org.glowroot.agent.shaded.google/guava/wiki/FunctionalExplained">the use of
 * {@code Predicate}</a>.
 *
...
public final class Predicates {
   ...
   * {@link org.glowroot.agent.shaded.google.common.collect.Iterables#filter(Iterable, Class)} in preference.
   *
