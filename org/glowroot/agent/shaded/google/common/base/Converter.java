 ...
 * example round-trip using {@link org.glowroot.agent.shaded.google.common.primitives.Doubles#stringConverter}:
 *
 * <ol>
 ...
 *     org.glowroot.agent.shaded.google.common.primitives.Ints#stringConverter Ints.stringConverter} or the {@linkplain
 *     #reverse reverse} views of these.
 * <li>Convert between specific preset values using {@link
 *     org.glowroot.agent.shaded.google.common.collect.Maps#asConverter Maps.asConverter}. For example, use this to create
