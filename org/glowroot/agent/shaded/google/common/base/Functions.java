...
/**
 * Static utility methods pertaining to {@code org.glowroot.agent.shaded.google.common.base.Function} instances; see that
 ...
 * <a href="https://github.org.glowroot.agent.shaded.google/guava/wiki/FunctionalExplained">the use of {@code
 * Function}</a>.
 *
 * @author Mike Bostock
 * @author Jared Levy
...
public final class Functions {
   ...
   *
   * <p>Note: if {@code map} is a {@link org.glowroot.agent.shaded.google.common.collect.BiMap BiMap} (or can be one), you
   * can use {@link org.glowroot.agent.shaded.google.common.collect.Maps#asConverter Maps.asConverter} instead to get a
