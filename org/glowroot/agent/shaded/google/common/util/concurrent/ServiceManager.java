...
import static org.glowroot.agent.shaded.google.common.base.Predicates.equalTo;
import static org.glowroot.agent.shaded.google.common.base.Predicates.in;
import static org.glowroot.agent.shaded.google.common.base.Predicates.instanceOf;
import static org.glowroot.agent.shaded.google.common.base.Predicates.not;
import static org.glowroot.agent.shaded.google.common.util.concurrent.MoreExecutors.directExecutor;
import static org.glowroot.agent.shaded.google.common.util.concurrent.Service.State.FAILED;
import static org.glowroot.agent.shaded.google.common.util.concurrent.Service.State.NEW;
import static org.glowroot.agent.shaded.google.common.util.concurrent.Service.State.RUNNING;
import static org.glowroot.agent.shaded.google.common.util.concurrent.Service.State.STARTING;
import static org.glowroot.agent.shaded.google.common.util.concurrent.Service.State.STOPPING;
import static org.glowroot.agent.shaded.google.common.util.concurrent.Service.State.TERMINATED;
import static java.util.concurrent.TimeUnit.MILLISECONDS;

import org.glowroot.agent.shaded.google.common.annotations.Beta;
...
import org.glowroot.agent.shaded.google.common.collect.Collections2;
...
import org.glowroot.agent.shaded.google.common.collect.MultimapBuilder;
import org.glowroot.agent.shaded.google.common.collect.Multimaps;
...
import org.glowroot.agent.shaded.google.common.util.concurrent.ListenerCallQueue.Callback;
import org.glowroot.agent.shaded.google.common.util.concurrent.Service.State;
import org.glowroot.agent.shaded.google.errorprone.annotations.CanIgnoreReturnValue;
