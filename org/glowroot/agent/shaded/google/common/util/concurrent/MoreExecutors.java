...
import org.glowroot.agent.shaded.google.common.util.concurrent.ForwardingListenableFuture.SimpleForwardingListenableFuture;
...
public final class MoreExecutors {
   ...
   *
   * @since 10.0 (<a href="https://github.org.glowroot.agent.shaded.google/guava/wiki/Compatibility">mostly
  ...
  public static ThreadFactory platformThreadFactory() {
    ...
    try {
      return (ThreadFactory)
          Class.forName("org.glowroot.agent.shaded.google.appengine.api.ThreadManager")
  ...
  private static boolean isAppEngine() {
    if (System.getProperty("org.glowroot.agent.shaded.google.appengine.runtime.environment") == null) {
      return false;
    }
    try {
      // If the current environment is null, we're not inside AppEngine.
      return Class.forName("org.glowroot.agent.shaded.google.apphosting.api.ApiProxy")
