...
package org.glowroot.agent.shaded.google.common.cache;
...
import static org.glowroot.agent.shaded.google.common.cache.CacheBuilder.NULL_TICKER;
import static org.glowroot.agent.shaded.google.common.cache.CacheBuilder.UNSET_INT;
import static org.glowroot.agent.shaded.google.common.util.concurrent.MoreExecutors.directExecutor;
import static org.glowroot.agent.shaded.google.common.util.concurrent.Uninterruptibles.getUninterruptibly;
import static java.util.concurrent.TimeUnit.NANOSECONDS;

import org.glowroot.agent.shaded.google.common.annotations.GwtCompatible;
import org.glowroot.agent.shaded.google.common.annotations.GwtIncompatible;
import org.glowroot.agent.shaded.google.common.annotations.VisibleForTesting;
import org.glowroot.agent.shaded.google.common.base.Equivalence;
...
import org.glowroot.agent.shaded.google.common.cache.AbstractCache.SimpleStatsCounter;
import org.glowroot.agent.shaded.google.common.cache.AbstractCache.StatsCounter;
import org.glowroot.agent.shaded.google.common.cache.CacheBuilder.NullListener;
import org.glowroot.agent.shaded.google.common.cache.CacheBuilder.OneWeigher;
import org.glowroot.agent.shaded.google.common.cache.CacheLoader.InvalidCacheLoadException;
import org.glowroot.agent.shaded.google.common.cache.CacheLoader.UnsupportedLoadingOperationException;
import org.glowroot.agent.shaded.google.common.collect.AbstractSequentialIterator;
...
import org.glowroot.agent.shaded.google.common.util.concurrent.ExecutionError;
...
import org.glowroot.agent.shaded.google.common.util.concurrent.UncheckedExecutionException;
import org.glowroot.agent.shaded.google.common.util.concurrent.Uninterruptibles;
import org.glowroot.agent.shaded.google.j2objc.annotations.Weak;
import org.glowroot.agent.shaded.google.j2objc.annotations.WeakOuter;
 ...
 *
 * @author Charles Fry
 * @author Bob Lee ({@code org.glowroot.agent.shaded.google.common.collect.MapMaker})
...
class LocalCache<K, V> extends AbstractMap<K, V> implements ConcurrentMap<K, V> {
  ...
  long longSize() {
    ...
    long sum = 0;
    for (int i = 0; i < segments.length; ++i) {
      sum += Math.max(0, segments[i].count); // see https://github.org.glowroot.agent.shaded.google/guava/issues/2108
    }
    return sum;
  }
