...
public interface LoadingCache<K, V> extends Cache<K, V>, Function<K, V> {
   ...
   *     <a href="https://github.org.glowroot.agent.shaded.google/guava/wiki/CachesExplained#interruption">even if
   ...
   * exception will be logged (using {@link org.glowroot.agent.jul.Logger}) and swallowed</i>.
   *
