...
public interface ReportResponseOrBuilder extends
   ...
   */
  java.util.List<org.glowroot.agent.shaded.google.api.servicecontrol.v1.ReportResponse.ReportError> 
      getReportErrorsList();
  /**
   * <pre>
   * Partial failures, one for each `Operation` in the request that failed
   ...
   * <code>repeated .google.api.servicecontrol.v1.ReportResponse.ReportError report_errors = 1;</code>
   */
  org.glowroot.agent.shaded.google.api.servicecontrol.v1.ReportResponse.ReportError getReportErrors(int index);
  /**
   * <pre>
   * Partial failures, one for each `Operation` in the request that failed
   * processing. There are three possible combinations of the RPC status:
   ...
   * <code>repeated .google.api.servicecontrol.v1.ReportResponse.ReportError report_errors = 1;</code>
   */
  java.util.List<? extends org.glowroot.agent.shaded.google.api.servicecontrol.v1.ReportResponse.ReportErrorOrBuilder> 
   ...
   * <code>repeated .google.api.servicecontrol.v1.ReportResponse.ReportError report_errors = 1;</code>
   */
  org.glowroot.agent.shaded.google.api.servicecontrol.v1.ReportResponse.ReportErrorOrBuilder getReportErrorsOrBuilder(
      int index);
