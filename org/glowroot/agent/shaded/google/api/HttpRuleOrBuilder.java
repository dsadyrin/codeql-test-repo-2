...
public interface HttpRuleOrBuilder extends
   ...
   */
  org.glowroot.agent.shaded.google.api.CustomHttpPattern getCustom();
  /**
   * <pre>
   * Custom pattern is used for defining custom verbs.
   * </pre>
   ...
   * <code>.google.api.CustomHttpPattern custom = 8;</code>
   */
  org.glowroot.agent.shaded.google.api.CustomHttpPatternOrBuilder getCustomOrBuilder();
   ...
   * <code>repeated .google.api.HttpRule additional_bindings = 11;</code>
   */
  org.glowroot.agent.shaded.google.api.HttpRule getAdditionalBindings(int index);
  /**
   * <pre>
   * Additional HTTP bindings for the selector. Nested bindings must
   * not contain an `additional_bindings` field themselves (that is,
   ...
   * <code>repeated .google.api.HttpRule additional_bindings = 11;</code>
   */
  org.glowroot.agent.shaded.google.api.HttpRuleOrBuilder getAdditionalBindingsOrBuilder(
      int index);

  public org.glowroot.agent.shaded.google.api.HttpRule.PatternCase getPatternCase();
}
