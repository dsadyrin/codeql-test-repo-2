 ...
 * <pre>
 * <code>
 * {@link org.glowroot.agent.shaded.HdrHistogram.Histogram} histogram = new {@link org.glowroot.agent.shaded.HdrHistogram.Histogram}(3600000000L, 3);
 * .
 * .
 * .
 * // Repeatedly record measured latencies:
 * histogram.{@link org.glowroot.agent.shaded.HdrHistogram.AbstractHistogram#recordValue(long) recordValue}(latency);
 * .
 * .
 * .
 * // Report histogram percentiles, expressed in msec units:
 * histogram.{@link org.glowroot.agent.shaded.HdrHistogram.AbstractHistogram#outputPercentileDistribution(java.io.PrintStream, Double) outputPercentileDistribution}(histogramLog, 1000.0)};
 * </code>
 * </pre>
 ...
 * The HdrHistogram package includes multiple implementations of the {@link org.glowroot.agent.shaded.HdrHistogram.AbstractHistogram} class:
 * <ul>
 *  <li> {@link org.glowroot.agent.shaded.HdrHistogram.Histogram}, which is the commonly used Histogram form and tracks value counts
 * in <b><code>long</code></b> fields. </li>
 *  <li>{@link org.glowroot.agent.shaded.HdrHistogram.IntCountsHistogram} and {@link org.glowroot.agent.shaded.HdrHistogram.ShortCountsHistogram}, which track value counts
 ...
 * being tracked).</li>
 *  <li>{@link org.glowroot.agent.shaded.HdrHistogram.AtomicHistogram}, {@link org.glowroot.agent.shaded.HdrHistogram.ConcurrentHistogram}
 *  and {@link org.glowroot.agent.shaded.HdrHistogram.SynchronizedHistogram}</li>
 * </ul>
 * <p>
 ...
 * In the interest of keeping value recording cost to a minimum, the commonly used {@link org.glowroot.agent.shaded.HdrHistogram.Histogram}
 * class and it's {@link org.glowroot.agent.shaded.HdrHistogram.IntCountsHistogram} and {@link org.glowroot.agent.shaded.HdrHistogram.ShortCountsHistogram}
 ...
 * synchronize and/or order their access, or use the {@link org.glowroot.agent.shaded.HdrHistogram.ConcurrentHistogram},
 * {@link org.glowroot.agent.shaded.HdrHistogram.AtomicHistogram}, or {@link org.glowroot.agent.shaded.HdrHistogram.SynchronizedHistogram} variants.
 * <p>
 ...
 * reporting operations are needed, consider using the {@link org.glowroot.agent.shaded.HdrHistogram.Recorder} and
 * {@link org.glowroot.agent.shaded.HdrHistogram.SingleWriterRecorder} variants that were specifically designed for that purpose.
 ...
 * non-synchronized histograms or {@link org.glowroot.agent.shaded.HdrHistogram.SingleWriterRecorder}s, and using a summary/reporting
 ...
 * each possible value level. The iteration mechanisms all provide {@link org.glowroot.agent.shaded.HdrHistogram.HistogramIterationValue}
 * data points along the histogram's iterated data set, and are available via the following methods:
 * <ul>
 *     <li>{@link org.glowroot.agent.shaded.HdrHistogram.AbstractHistogram#percentiles percentiles} :
 *     An {@link java.lang.Iterable}{@literal <}{@link org.glowroot.agent.shaded.HdrHistogram.HistogramIterationValue}{@literal >} through the
 *     histogram using a {@link org.glowroot.agent.shaded.HdrHistogram.PercentileIterator} </li>
 *     <li>{@link org.glowroot.agent.shaded.HdrHistogram.AbstractHistogram#linearBucketValues linearBucketValues} :
 *     An {@link java.lang.Iterable}{@literal <}{@link org.glowroot.agent.shaded.HdrHistogram.HistogramIterationValue}{@literal >} through
 *     the histogram using a {@link org.glowroot.agent.shaded.HdrHistogram.LinearIterator} </li>
 *     <li>{@link org.glowroot.agent.shaded.HdrHistogram.AbstractHistogram#logarithmicBucketValues logarithmicBucketValues} :
 *     An {@link java.lang.Iterable}{@literal <}{@link org.glowroot.agent.shaded.HdrHistogram.HistogramIterationValue}{@literal >}
 *     through the histogram using a {@link org.glowroot.agent.shaded.HdrHistogram.LogarithmicIterator} </li>
 *     <li>{@link org.glowroot.agent.shaded.HdrHistogram.AbstractHistogram#recordedValues recordedValues} :
 *     An {@link java.lang.Iterable}{@literal <}{@link org.glowroot.agent.shaded.HdrHistogram.HistogramIterationValue}{@literal >} through
 *     the histogram using a {@link org.glowroot.agent.shaded.HdrHistogram.RecordedValuesIterator} </li>
 *     <li>{@link org.glowroot.agent.shaded.HdrHistogram.AbstractHistogram#allValues allValues} :
 *     An {@link java.lang.Iterable}{@literal <}{@link org.glowroot.agent.shaded.HdrHistogram.HistogramIterationValue}{@literal >} through
 *     the histogram using a {@link org.glowroot.agent.shaded.HdrHistogram.AllValuesIterator} </li>
 * </ul>
 * <p>
 ...
 * {@link org.glowroot.agent.shaded.HdrHistogram.AbstractHistogram#recordValue(long) recordValue()} method.
 * <p>
 * Histogram variants also provide an auto-correcting
 * {@link org.glowroot.agent.shaded.HdrHistogram.AbstractHistogram#recordValueWithExpectedInterval(long, long) recordValueWithExpectedInterval()}
 ...
 * {@link org.glowroot.agent.shaded.HdrHistogram.AbstractHistogram#recordValue(long) recordValue()}
 * and with
 * {@link org.glowroot.agent.shaded.HdrHistogram.AbstractHistogram#recordValueWithExpectedInterval(long, long) recordValueWithExpectedInterval()}
 ...
 * methods
 * {@link org.glowroot.agent.shaded.HdrHistogram.AbstractHistogram#copyCorrectedForCoordinatedOmission(long) copyCorrectedForCoordinatedOmission()}
 * and
 * {@link org.glowroot.agent.shaded.HdrHistogram.AbstractHistogram#addWhileCorrectingForCoordinatedOmission(AbstractHistogram, long) addWhileCorrectingForCoordinatedOmission()}.
 ...
 * {@link org.glowroot.agent.shaded.HdrHistogram.AbstractHistogram} and their related supporting classes). HdrHistogram supports floating
 * point value recording and reporting with a similar set of classes, including the
 * {@link org.glowroot.agent.shaded.HdrHistogram.DoubleHistogram}, {@link org.glowroot.agent.shaded.HdrHistogram.ConcurrentDoubleHistogram} and
 * {@link org.glowroot.agent.shaded.HdrHistogram.SynchronizedDoubleHistogram} histogram classes. Support for floating point value
 * iteration is provided with {@link org.glowroot.agent.shaded.HdrHistogram.DoubleHistogramIterationValue} and related iterator classes (
 * {@link org.glowroot.agent.shaded.HdrHistogram.DoubleLinearIterator}, {@link org.glowroot.agent.shaded.HdrHistogram.DoubleLogarithmicIterator},
 * {@link org.glowroot.agent.shaded.HdrHistogram.DoublePercentileIterator}, {@link org.glowroot.agent.shaded.HdrHistogram.DoubleRecordedValuesIterator},
 * {@link org.glowroot.agent.shaded.HdrHistogram.DoubleAllValuesIterator}). Support for interval recording is provided with
 * {@link org.glowroot.agent.shaded.HdrHistogram.DoubleRecorder} and
 * {@link org.glowroot.agent.shaded.HdrHistogram.SingleWriterDoubleRecorder}.
 ...
 * org.glowroot.agent.shaded.HdrHistogram.DoubleHistogram} (and variants) is not specified upfront. Only the dynamic range of values
 * that the histogram can cover is (optionally) specified. E.g. When a {@link org.glowroot.agent.shaded.HdrHistogram.DoubleHistogram}
 ...
 * {@link org.glowroot.agent.shaded.HdrHistogram.AbstractHistogram#getEstimatedFootprintInBytes() getEstimatedFootprintInBytes()} method.
 */

package org.glowroot.agent.shaded.HdrHistogram;
