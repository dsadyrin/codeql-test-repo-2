 ...
 * <p>
 * See package description for {@link org.glowroot.agent.shaded.HdrHistogram} for details.
 */
public class DoubleHistogram extends EncodableHistogram implements Serializable {
     ...
     * of significant decimal digits.
     *
     * The {@link org.glowroot.agent.shaded.HdrHistogram.DoubleHistogram} will use the specified AbstractHistogram subclass
     * for tracking internal counts (e.g. {@link org.glowroot.agent.shaded.HdrHistogram.Histogram},
     * {@link org.glowroot.agent.shaded.HdrHistogram.ConcurrentHistogram}, {@link org.glowroot.agent.shaded.HdrHistogram.SynchronizedHistogram},
     * {@link org.glowroot.agent.shaded.HdrHistogram.IntCountsHistogram}, {@link org.glowroot.agent.shaded.HdrHistogram.ShortCountsHistogram}).
     *
     * @param numberOfSignificantValueDigits Specifies the precision to use. This is the number of significant
     *                                       decimal digits to which the histogram will maintain value resolution
     *                                       and separation. Must be a non-negative integer between 0 and 5.
    ...
    /**
     * Construct a {@link org.glowroot.agent.shaded.HdrHistogram.DoubleHistogram} with the same range settings as a given source,
     ...
     * {@link org.glowroot.agent.shaded.HdrHistogram.HistogramIterationValue#getDoubleValueIteratedTo() getDoubleValueIteratedTo()}
     * and
     * {@link org.glowroot.agent.shaded.HdrHistogram.HistogramIterationValue#getDoubleValueIteratedFrom() getDoubleValueIteratedFrom()}
     * accessors to {@link org.glowroot.agent.shaded.HdrHistogram.HistogramIterationValue} iterated values.
     *
     ...
     * {@link org.glowroot.agent.shaded.HdrHistogram.DoubleHistogram#valuesAreEquivalent} would return true.
     *
     ...
     * specified AbstractHistogram subclass for tracking internal counts (e.g. {@link org.glowroot.agent.shaded.HdrHistogram.Histogram},
     * {@link org.glowroot.agent.shaded.HdrHistogram.ConcurrentHistogram}, {@link org.glowroot.agent.shaded.HdrHistogram.SynchronizedHistogram},
     * {@link org.glowroot.agent.shaded.HdrHistogram.IntCountsHistogram}, {@link org.glowroot.agent.shaded.HdrHistogram.ShortCountsHistogram}).
     *
     * @param buffer The buffer to decode from
     ...
     * specified AbstractHistogram subclass for tracking internal counts (e.g. {@link org.glowroot.agent.shaded.HdrHistogram.Histogram},
     * {@link org.glowroot.agent.shaded.HdrHistogram.AtomicHistogram}, {@link org.glowroot.agent.shaded.HdrHistogram.SynchronizedHistogram},
     * {@link org.glowroot.agent.shaded.HdrHistogram.IntCountsHistogram}, {@link org.glowroot.agent.shaded.HdrHistogram.ShortCountsHistogram}).
     *
     * @param buffer The buffer to decode from
     * @param internalCountsHistogramClass The class to use for internal counts tracking
