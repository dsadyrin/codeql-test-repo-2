...
/**
 * Immutable implementation of {@link TransactionJsonService.FlameGraphRequest}.
 * <p>
 * Use the builder to create immutable instances:
 * {@code ImmutableFlameGraphRequest.builder()}.
 */
@SuppressWarnings({"all"})
@ParametersAreNonnullByDefault
@Generated({"Immutables.generator", "TransactionJsonService.FlameGraphRequest"})
@Immutable
final class ImmutableFlameGraphRequest
  ...
  private ImmutableFlameGraphRequest(
      boolean auxiliary,
  ...
  /**
   * Copy the current immutable object by setting a value for the {@link TransactionJsonService.FlameGraphRequest#auxiliary() auxiliary} attribute.
  ...
  public final ImmutableFlameGraphRequest withAuxiliary(boolean value) {
    ...
    return new ImmutableFlameGraphRequest(
        value,
        this.include,
        this.exclude,
  ...
  /**
   * Copy the current immutable object with elements that replace the content of {@link TransactionJsonService.FlameGraphRequest#include() include}.
  ...
  /**
   * Copy the current immutable object with elements that replace the content of {@link TransactionJsonService.FlameGraphRequest#exclude() exclude}.
   * @param elements The elements to set
   * @return A modified copy of {@code this} object
   */
  ...
  /**
   * Copy the current immutable object by setting a value for the {@link TransactionJsonService.FlameGraphRequest#truncateBranchPercentage() truncateBranchPercentage} attribute.
  ...
  /**
   * Copy the current immutable object by setting a value for the {@link TransactionJsonService.FlameGraphRequest#transactionType() transactionType} attribute.
  ...
  /**
   * Copy the current immutable object by setting a value for the {@link TransactionJsonService.FlameGraphRequest#transactionName() transactionName} attribute.
   * An equals check used to prevent copying of the same value by returning {@code this}.
   * @param value A new value for transactionName (can be {@code null})
   * @return A modified copy of the {@code this} object
   */
  public final ImmutableFlameGraphRequest withTransactionName(@Nullable String value) {
  ...
  /**
   * Copy the current immutable object by setting a value for the {@link TransactionJsonService.FlameGraphRequest#from() from} attribute.
   * A value equality check is used to prevent copying of the same value by returning {@code this}.
  ...
  /**
   * Copy the current immutable object by setting a value for the {@link TransactionJsonService.FlameGraphRequest#to() to} attribute.
   * A value equality check is used to prevent copying of the same value by returning {@code this}.
  ...
  /**
   * This instance is equal to all instances of {@code ImmutableFlameGraphRequest} that have equal attribute values.
   * @return {@code true} if {@code this} is equal to {@code another} instance
   */
  @Override
  public boolean equals(@Nullable Object another) {
    if (this == another) return true;
    return another instanceof ImmutableFlameGraphRequest
        && equalTo((ImmutableFlameGraphRequest) another);
  }

  private boolean equalTo(ImmutableFlameGraphRequest another) {
  ...
  /**
   * Prints the immutable value {@code FlameGraphRequest} with attribute values.
   * @return A string representation of the value
   */
  @Override
  public String toString() {
    return MoreObjects.toStringHelper("FlameGraphRequest")
        .omitNullValues()
  ...
  static final class Json implements TransactionJsonService.FlameGraphRequest {
    boolean auxiliary;
  ...
  static ImmutableFlameGraphRequest fromJson(Json json) {
    ImmutableFlameGraphRequest.Builder builder = ImmutableFlameGraphRequest.builder();
  ...
  /**
   * Creates an immutable copy of a {@link TransactionJsonService.FlameGraphRequest} value.
   * Uses accessors to get values to initialize the new immutable instance.
   * If an instance is already immutable, it is returned as is.
   * @param instance The instance to copy
   * @return A copied immutable FlameGraphRequest instance
   */
  public static ImmutableFlameGraphRequest copyOf(TransactionJsonService.FlameGraphRequest instance) {
    ...
    return ImmutableFlameGraphRequest.builder()
        .copyFrom(instance)
        .build();
  }

  /**
   * Creates a builder for {@link ImmutableFlameGraphRequest ImmutableFlameGraphRequest}.
   * @return A new ImmutableFlameGraphRequest builder
   */
  public static ImmutableFlameGraphRequest.Builder builder() {
    return new ImmutableFlameGraphRequest.Builder();
  }

  /**
   * Builds instances of type {@link ImmutableFlameGraphRequest ImmutableFlameGraphRequest}.
  ...
  public static final class Builder {
    ...
    /**
     * Fill a builder with attribute values from the provided {@code org.glowroot.agent.shaded.glowroot.ui.TransactionJsonService.FlameGraphRequest} instance.
     * @param instance The instance from which to copy values
     * @return {@code this} builder for use in a chained invocation
     */
    ...
    private void from(Object object) {
      ...
      if (object instanceof TransactionJsonService.FlameGraphRequest) {
        TransactionJsonService.FlameGraphRequest instance = (TransactionJsonService.FlameGraphRequest) object;
    ...
    /**
     * Initializes the value for the {@link TransactionJsonService.FlameGraphRequest#auxiliary() auxiliary} attribute.
    ...
    /**
     * Adds one element to {@link TransactionJsonService.FlameGraphRequest#include() include} list.
    ...
    /**
     * Adds elements to {@link TransactionJsonService.FlameGraphRequest#include() include} list.
    ...
    /**
     * Sets or replaces all elements for {@link TransactionJsonService.FlameGraphRequest#include() include} list.
    ...
    /**
     * Adds one element to {@link TransactionJsonService.FlameGraphRequest#exclude() exclude} list.
    ...
    /**
     * Adds elements to {@link TransactionJsonService.FlameGraphRequest#exclude() exclude} list.
    ...
    /**
     * Sets or replaces all elements for {@link TransactionJsonService.FlameGraphRequest#exclude() exclude} list.
    ...
    /**
     * Initializes the value for the {@link TransactionJsonService.FlameGraphRequest#truncateBranchPercentage() truncateBranchPercentage} attribute.
    ...
    /**
     * Initializes the value for the {@link TransactionJsonService.FlameGraphRequest#transactionType() transactionType} attribute.
    ...
    /**
     * Initializes the value for the {@link TransactionJsonService.FlameGraphRequest#transactionName() transactionName} attribute.
    ...
    /**
     * Initializes the value for the {@link TransactionJsonService.FlameGraphRequest#from() from} attribute.
    ...
    /**
     * Initializes the value for the {@link TransactionJsonService.FlameGraphRequest#to() to} attribute.
    ...
    /**
     * Builds a new {@link ImmutableFlameGraphRequest ImmutableFlameGraphRequest}.
     * @return An immutable instance of FlameGraphRequest
