...
import org.glowroot.agent.shaded.glowroot.ui.TraceCommonService.TraceExport;
...
class TraceExportHttpService implements HttpService {
    ...
    private static CharSource asCharSource(String exportResourceName) {
        URL url = TraceExportHttpService.class
                .getResource("/org.glowroot.agent.shaded.glowroot.ui/export-dist/" + exportResourceName);
