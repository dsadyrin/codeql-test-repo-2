...
import org.glowroot.agent.shaded.google.common.collect.EvictingQueue;
...
import org.glowroot.agent.shaded.google.common.io.LineProcessor;
...
class GlowrootLogHttpService implements HttpService {
    ...
    public CommonResponse handleRequest(CommonRequest request, Authentication authentication)
        ...
        for (File file : files) {
            ...
            // (see org.glowroot.agent.shaded.qos.logback.core.rolling.SizeBasedTriggeringPolicy call to isTooSoon())
