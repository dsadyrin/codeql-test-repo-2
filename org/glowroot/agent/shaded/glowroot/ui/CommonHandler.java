...
import org.glowroot.agent.shaded.netty.handler.codec.http.DefaultHttpHeaders;
...
import static org.glowroot.agent.shaded.netty.handler.codec.http.HttpResponseStatus.FORBIDDEN;
...
import static org.glowroot.agent.shaded.netty.handler.codec.http.HttpResponseStatus.NOT_MODIFIED;
import static org.glowroot.agent.shaded.netty.handler.codec.http.HttpResponseStatus.OK;
import static org.glowroot.agent.shaded.netty.handler.codec.http.HttpResponseStatus.REQUEST_TIMEOUT;
import static org.glowroot.agent.shaded.netty.handler.codec.http.HttpResponseStatus.UNAUTHORIZED;
...
public class CommonHandler {
    ...
    // this constant is from org.glowroot.agent.shaded.h2.api.ErrorCode.STATEMENT_WAS_CANCELED
    ...
    private @Nullable Date getExpiresForPath(String path) {
        if (path.startsWith("org.glowroot.agent.shaded.glowroot.ui/app-dist/favicon.")) {
