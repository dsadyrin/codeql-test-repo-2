...
public final class DownstreamServiceGrpc {
  ...
  public static final String SERVICE_NAME = "org.glowroot.agent.shaded.glowroot.wire.api_model.DownstreamService";

  // Static method descriptors that strictly reflect the proto.
  @org.glowroot.agent.shaded.grpc.ExperimentalApi("https://github.com/grpc/grpc-java/issues/1901")
  public static final org.glowroot.agent.shaded.grpc.MethodDescriptor<org.glowroot.agent.shaded.glowroot.wire.api.model.DownstreamServiceOuterClass.AgentResponse,
      org.glowroot.agent.shaded.glowroot.wire.api.model.DownstreamServiceOuterClass.CentralRequest> METHOD_CONNECT =
      org.glowroot.agent.shaded.grpc.MethodDescriptor.<org.glowroot.agent.shaded.glowroot.wire.api.model.DownstreamServiceOuterClass.AgentResponse, org.glowroot.agent.shaded.glowroot.wire.api.model.DownstreamServiceOuterClass.CentralRequest>newBuilder()
          .setType(org.glowroot.agent.shaded.grpc.MethodDescriptor.MethodType.BIDI_STREAMING)
          .setFullMethodName(generateFullMethodName(
              "org.glowroot.agent.shaded.glowroot.wire.api_model.DownstreamService", "connect"))
          .setRequestMarshaller(org.glowroot.agent.shaded.grpc.protobuf.ProtoUtils.marshaller(
              org.glowroot.agent.shaded.glowroot.wire.api.model.DownstreamServiceOuterClass.AgentResponse.getDefaultInstance()))
          .setResponseMarshaller(org.glowroot.agent.shaded.grpc.protobuf.ProtoUtils.marshaller(
              org.glowroot.agent.shaded.glowroot.wire.api.model.DownstreamServiceOuterClass.CentralRequest.getDefaultInstance()))
          .build();
  ...
  /**
   */
  public static abstract class DownstreamServiceImplBase implements org.glowroot.agent.shaded.grpc.BindableService {

    /**
     */
    public org.glowroot.agent.shaded.grpc.stub.StreamObserver<org.glowroot.agent.shaded.glowroot.wire.api.model.DownstreamServiceOuterClass.AgentResponse> connect(
        org.glowroot.agent.shaded.grpc.stub.StreamObserver<org.glowroot.agent.shaded.glowroot.wire.api.model.DownstreamServiceOuterClass.CentralRequest> responseObserver) {
      ...
      return org.glowroot.agent.shaded.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncBidiStreamingCall(
              new MethodHandlers<
                org.glowroot.agent.shaded.glowroot.wire.api.model.DownstreamServiceOuterClass.AgentResponse,
                org.glowroot.agent.shaded.glowroot.wire.api.model.DownstreamServiceOuterClass.CentralRequest>(
  ...
  /**
   */
  public static final class DownstreamServiceStub extends org.glowroot.agent.shaded.grpc.stub.AbstractStub<DownstreamServiceStub> {
  ...
  /**
   */
  public static final class DownstreamServiceBlockingStub extends org.glowroot.agent.shaded.grpc.stub.AbstractStub<DownstreamServiceBlockingStub> {
  ...
  /**
   */
  public static final class DownstreamServiceFutureStub extends org.glowroot.agent.shaded.grpc.stub.AbstractStub<DownstreamServiceFutureStub> {
    ...
    public org.glowroot.agent.shaded.grpc.stub.StreamObserver<Req> invoke(
      ...
      switch (methodId) {
        case METHODID_CONNECT:
          return (org.glowroot.agent.shaded.grpc.stub.StreamObserver<Req>) serviceImpl.connect(
              (org.glowroot.agent.shaded.grpc.stub.StreamObserver<org.glowroot.agent.shaded.glowroot.wire.api.model.DownstreamServiceOuterClass.CentralRequest>) responseObserver);
        default:
          throw new AssertionError();
      }
  ...
  private static final class DownstreamServiceDescriptorSupplier implements org.glowroot.agent.shaded.grpc.protobuf.ProtoFileDescriptorSupplier {
    @java.lang.Override
    public org.glowroot.agent.shaded.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return org.glowroot.agent.shaded.glowroot.wire.api.model.DownstreamServiceOuterClass.getDescriptor();
    }
  }
