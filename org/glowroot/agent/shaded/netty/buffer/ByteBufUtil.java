...
import org.glowroot.agent.shaded.netty.util.ByteProcessor;
import org.glowroot.agent.shaded.netty.util.CharsetUtil;
import org.glowroot.agent.shaded.netty.util.Recycler;
import org.glowroot.agent.shaded.netty.util.Recycler.Handle;
...
import static org.glowroot.agent.shaded.netty.util.internal.MathUtil.isOutOfBounds;
...
import static org.glowroot.agent.shaded.netty.util.internal.StringUtil.isSurrogate;
...
public final class ByteBufUtil {
    ...
    static {
        String allocType = SystemPropertyUtil.get(
                "org.glowroot.agent.shaded.netty.allocator.type", PlatformDependent.isAndroid() ? "unpooled" : "pooled");
        ...
        THREAD_LOCAL_BUFFER_SIZE = SystemPropertyUtil.getInt("org.glowroot.agent.shaded.netty.threadLocalDirectBufferSize", 64 * 1024);
        logger.debug("-Dio.netty.threadLocalDirectBufferSize: {}", THREAD_LOCAL_BUFFER_SIZE);

        MAX_CHAR_BUFFER_SIZE = SystemPropertyUtil.getInt("org.glowroot.agent.shaded.netty.maxThreadLocalCharBufferSize", 16 * 1024);
