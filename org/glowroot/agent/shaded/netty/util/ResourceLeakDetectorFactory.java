        ...
        DefaultResourceLeakDetectorFactory() {
            ...
            try {
                customLeakDetector = AccessController.doPrivileged(new PrivilegedAction<String>() {
                    @Override
                    public String run() {
                        return SystemPropertyUtil.get("org.glowroot.agent.shaded.netty.customResourceLeakDetector");
                    }
                });
            } catch (Throwable cause) {
                logger.error("Could not access System property: org.glowroot.agent.shaded.netty.customResourceLeakDetector", cause);
