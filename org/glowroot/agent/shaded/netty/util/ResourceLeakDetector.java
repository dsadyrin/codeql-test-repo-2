...
import static org.glowroot.agent.shaded.netty.util.internal.StringUtil.EMPTY_STRING;
import static org.glowroot.agent.shaded.netty.util.internal.StringUtil.NEWLINE;
import static org.glowroot.agent.shaded.netty.util.internal.StringUtil.simpleClassName;

public class ResourceLeakDetector<T> {

    private static final String PROP_LEVEL_OLD = "org.glowroot.agent.shaded.netty.leakDetectionLevel";
    private static final String PROP_LEVEL = "org.glowroot.agent.shaded.netty.leakDetection.level";
    private static final Level DEFAULT_LEVEL = Level.SIMPLE;

    private static final String PROP_MAX_RECORDS = "org.glowroot.agent.shaded.netty.leakDetection.maxRecords";
    ...
    static {
        ...
        if (SystemPropertyUtil.get("org.glowroot.agent.shaded.netty.noResourceLeakDetection") != null) {
            disabled = SystemPropertyUtil.getBoolean("org.glowroot.agent.shaded.netty.noResourceLeakDetection", false);
    ...
    private static final String[] STACK_TRACE_ELEMENT_EXCLUSIONS = {
            "org.glowroot.agent.shaded.netty.util.ReferenceCountUtil.touch(",
            "org.glowroot.agent.shaded.netty.buffer.AdvancedLeakAwareByteBuf.touch(",
            "org.glowroot.agent.shaded.netty.buffer.AbstractByteBufAllocator.toLeakAwareBuffer(",
            "org.glowroot.agent.shaded.netty.buffer.AdvancedLeakAwareByteBuf.recordLeakNonRefCountingOperation("
    };
