...
public final class NativeLibraryLoader {
    ...
    static {
        ...
        String workdir = SystemPropertyUtil.get("org.glowroot.agent.shaded.netty.native.workdir");
        if (workdir != null) {
            ...
            WORKDIR = tmpdir();
            logger.debug("-Dio.netty.native.workdir: " + WORKDIR + " (org.glowroot.agent.shaded.netty.tmpdir)");
        }

        DELETE_NATIVE_LIB_AFTER_LOADING = SystemPropertyUtil.getBoolean(
                "org.glowroot.agent.shaded.netty.native.deleteLibAfterLoading", true);
    }
