...
public final class SelfSignedCertificate {
    ...
    private static final Date DEFAULT_NOT_BEFORE = new Date(SystemPropertyUtil.getLong(
            "org.glowroot.agent.shaded.netty.selfSignedCertificate.defaultNotBefore", System.currentTimeMillis() - 86400000L * 365));
    /** The maximum possible value in X.509 specification: 9999-12-31 23:59:59 */
    private static final Date DEFAULT_NOT_AFTER = new Date(SystemPropertyUtil.getLong(
            "org.glowroot.agent.shaded.netty.selfSignedCertificate.defaultNotAfter", 253402300799000L));
