...
import org.glowroot.agent.shaded.netty.internal.tcnative.CertificateVerifier;
import org.glowroot.agent.shaded.netty.internal.tcnative.SSL;
import org.glowroot.agent.shaded.netty.internal.tcnative.SSLContext;
...
public abstract class ReferenceCountedOpenSslContext extends SslContext implements ReferenceCounted {
    ...
    private static final int DEFAULT_BIO_NON_APPLICATION_BUFFER_SIZE =
            AccessController.doPrivileged(new PrivilegedAction<Integer>() {
                ...
                public Integer run() {
                    return Math.max(1,
                            SystemPropertyUtil.getInt("org.glowroot.agent.shaded.netty.handler.ssl.openssl.bioNonApplicationBufferSize",
                                                      2048));
                }
            });
