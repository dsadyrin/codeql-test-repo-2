...
import org.glowroot.agent.shaded.netty.channel.ChannelConfig;
import org.glowroot.agent.shaded.netty.channel.ChannelException;
...
import org.glowroot.agent.shaded.netty.channel.ChannelPromiseNotifier;
import org.glowroot.agent.shaded.netty.channel.PendingWriteQueue;
...
import org.glowroot.agent.shaded.netty.util.concurrent.DefaultPromise;
...
import org.glowroot.agent.shaded.netty.util.concurrent.FutureListener;
import org.glowroot.agent.shaded.netty.util.concurrent.ImmediateExecutor;
...
import org.glowroot.agent.shaded.netty.util.internal.ThrowableUtil;
...
import static org.glowroot.agent.shaded.netty.handler.ssl.SslUtils.getEncryptedPacketLength;
    ...
    private boolean ignoreException(Throwable t) {
        if (!(t instanceof SSLException) && t instanceof IOException && sslClosePromise.isDone()) {
            ...
            for (StackTraceElement element: elements) {
                ...
                // skip all classes that belong to the org.glowroot.agent.shaded.netty package
                if (classname.startsWith("org.glowroot.agent.shaded.netty.")) {
                    continue;
                }
