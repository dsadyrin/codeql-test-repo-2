 ...
 * under the License.
 */
package org.glowroot.agent.shaded.netty.handler.codec.protobuf;

import org.glowroot.agent.shaded.google.protobuf.nano.MessageNano;
...
import org.glowroot.agent.shaded.netty.handler.codec.LengthFieldBasedFrameDecoder;
import org.glowroot.agent.shaded.netty.handler.codec.MessageToMessageDecoder;
import org.glowroot.agent.shaded.netty.util.internal.ObjectUtil;

/**
 * Decodes a received {@link ByteBuf} into a
 * <a href="https://github.org.glowroot.agent.shaded.google/protobuf">Google Protocol Buffers</a>
 ...
 *
 * // Encoder
 * pipeline.addLast("frameEncoder", new {@link org.glowroot.agent.shaded.netty.handler.codec.LengthFieldPrepender}(4));
