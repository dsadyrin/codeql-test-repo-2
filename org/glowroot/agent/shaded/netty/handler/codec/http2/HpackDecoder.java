...
import org.glowroot.agent.shaded.netty.handler.codec.http2.HpackUtil.IndexType;
import org.glowroot.agent.shaded.netty.util.AsciiString;

import static org.glowroot.agent.shaded.netty.handler.codec.http2.Http2CodecUtil.DEFAULT_HEADER_TABLE_SIZE;
...
import static org.glowroot.agent.shaded.netty.handler.codec.http2.Http2Error.COMPRESSION_ERROR;
...
import static org.glowroot.agent.shaded.netty.util.AsciiString.EMPTY_STRING;
import static org.glowroot.agent.shaded.netty.util.internal.ObjectUtil.checkPositive;
import static org.glowroot.agent.shaded.netty.util.internal.ThrowableUtil.unknownStackTrace;
