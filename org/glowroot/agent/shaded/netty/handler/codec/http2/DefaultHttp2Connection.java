...
import org.glowroot.agent.shaded.netty.handler.codec.http2.Http2Stream.State;
import org.glowroot.agent.shaded.netty.util.collection.IntObjectHashMap;
import org.glowroot.agent.shaded.netty.util.collection.IntObjectMap;
import org.glowroot.agent.shaded.netty.util.collection.IntObjectMap.PrimitiveEntry;
...
import org.glowroot.agent.shaded.netty.util.concurrent.UnaryPromiseNotifier;
...
import static org.glowroot.agent.shaded.netty.handler.codec.http2.Http2CodecUtil.CONNECTION_STREAM_ID;
import static org.glowroot.agent.shaded.netty.handler.codec.http2.Http2CodecUtil.DEFAULT_MAX_RESERVED_STREAMS;
import static org.glowroot.agent.shaded.netty.handler.codec.http2.Http2Error.INTERNAL_ERROR;
import static org.glowroot.agent.shaded.netty.handler.codec.http2.Http2Error.PROTOCOL_ERROR;
import static org.glowroot.agent.shaded.netty.handler.codec.http2.Http2Error.REFUSED_STREAM;
import static org.glowroot.agent.shaded.netty.handler.codec.http2.Http2Exception.closedStreamError;
...
import static org.glowroot.agent.shaded.netty.handler.codec.http2.Http2Stream.State.CLOSED;
import static org.glowroot.agent.shaded.netty.handler.codec.http2.Http2Stream.State.HALF_CLOSED_LOCAL;
import static org.glowroot.agent.shaded.netty.handler.codec.http2.Http2Stream.State.HALF_CLOSED_REMOTE;
import static org.glowroot.agent.shaded.netty.handler.codec.http2.Http2Stream.State.IDLE;
import static org.glowroot.agent.shaded.netty.handler.codec.http2.Http2Stream.State.OPEN;
import static org.glowroot.agent.shaded.netty.handler.codec.http2.Http2Stream.State.RESERVED_LOCAL;
import static org.glowroot.agent.shaded.netty.handler.codec.http2.Http2Stream.State.RESERVED_REMOTE;
import static org.glowroot.agent.shaded.netty.util.internal.ObjectUtil.checkNotNull;
import static org.glowroot.agent.shaded.netty.util.internal.ObjectUtil.checkPositiveOrZero;
