...
import org.glowroot.agent.shaded.netty.channel.embedded.EmbeddedChannel;
import org.glowroot.agent.shaded.netty.handler.codec.ByteToMessageDecoder;
import org.glowroot.agent.shaded.netty.handler.codec.compression.ZlibCodecFactory;
import org.glowroot.agent.shaded.netty.handler.codec.compression.ZlibWrapper;
import org.glowroot.agent.shaded.netty.util.internal.UnstableApi;

import static org.glowroot.agent.shaded.netty.handler.codec.http.HttpHeaderNames.CONTENT_ENCODING;
import static org.glowroot.agent.shaded.netty.handler.codec.http.HttpHeaderNames.CONTENT_LENGTH;
import static org.glowroot.agent.shaded.netty.handler.codec.http.HttpHeaderValues.DEFLATE;
import static org.glowroot.agent.shaded.netty.handler.codec.http.HttpHeaderValues.GZIP;
import static org.glowroot.agent.shaded.netty.handler.codec.http.HttpHeaderValues.IDENTITY;
import static org.glowroot.agent.shaded.netty.handler.codec.http.HttpHeaderValues.X_DEFLATE;
import static org.glowroot.agent.shaded.netty.handler.codec.http.HttpHeaderValues.X_GZIP;
