...
import org.glowroot.agent.shaded.netty.handler.codec.http.FullHttpMessage;
...
import static org.glowroot.agent.shaded.netty.handler.codec.http.HttpScheme.HTTP;
import static org.glowroot.agent.shaded.netty.handler.codec.http.HttpScheme.HTTPS;
import static org.glowroot.agent.shaded.netty.handler.codec.http.HttpUtil.isAsteriskForm;
import static org.glowroot.agent.shaded.netty.handler.codec.http.HttpUtil.isOriginForm;
...
import static org.glowroot.agent.shaded.netty.util.ByteProcessor.FIND_SEMI_COLON;
import static org.glowroot.agent.shaded.netty.util.internal.ObjectUtil.checkNotNull;
import static org.glowroot.agent.shaded.netty.util.internal.StringUtil.isNullOrEmpty;
import static org.glowroot.agent.shaded.netty.util.internal.StringUtil.length;
