...
import org.glowroot.agent.shaded.netty.util.collection.IntCollections;
...
import org.glowroot.agent.shaded.netty.util.internal.DefaultPriorityQueue;
import org.glowroot.agent.shaded.netty.util.internal.EmptyPriorityQueue;
import org.glowroot.agent.shaded.netty.util.internal.MathUtil;
import org.glowroot.agent.shaded.netty.util.internal.PriorityQueue;
import org.glowroot.agent.shaded.netty.util.internal.PriorityQueueNode;
...
import static org.glowroot.agent.shaded.netty.handler.codec.http2.Http2CodecUtil.DEFAULT_MIN_ALLOCATION_CHUNK;
import static org.glowroot.agent.shaded.netty.handler.codec.http2.Http2CodecUtil.DEFAULT_PRIORITY_WEIGHT;
import static org.glowroot.agent.shaded.netty.handler.codec.http2.Http2CodecUtil.streamableBytes;
...
public final class WeightedFairQueueByteDistributor implements StreamByteDistributor {
    ...
    static final int INITIAL_CHILDREN_MAP_SIZE =
            max(1, SystemPropertyUtil.getInt("org.glowroot.agent.shaded.netty.http2.childrenMapSize", 2));
    /**
