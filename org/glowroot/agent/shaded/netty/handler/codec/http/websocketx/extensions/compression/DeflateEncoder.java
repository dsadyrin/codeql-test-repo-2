 ...
 * under the License.
 */
package org.glowroot.agent.shaded.netty.handler.codec.http.websocketx.extensions.compression;

import static org.glowroot.agent.shaded.netty.handler.codec.http.websocketx.extensions.compression.PerMessageDeflateDecoder.*;
import org.glowroot.agent.shaded.netty.buffer.ByteBuf;
import org.glowroot.agent.shaded.netty.buffer.CompositeByteBuf;
...
import org.glowroot.agent.shaded.netty.handler.codec.CodecException;
...
import org.glowroot.agent.shaded.netty.handler.codec.http.websocketx.BinaryWebSocketFrame;
import org.glowroot.agent.shaded.netty.handler.codec.http.websocketx.ContinuationWebSocketFrame;
import org.glowroot.agent.shaded.netty.handler.codec.http.websocketx.TextWebSocketFrame;
import org.glowroot.agent.shaded.netty.handler.codec.http.websocketx.WebSocketFrame;
import org.glowroot.agent.shaded.netty.handler.codec.http.websocketx.extensions.WebSocketExtensionEncoder;

import java.util.List;

/**
 * Deflate implementation of a payload compressor for
 * <tt>org.glowroot.agent.shaded.netty.handler.codec.http.websocketx.WebSocketFrame</tt>.
 */
