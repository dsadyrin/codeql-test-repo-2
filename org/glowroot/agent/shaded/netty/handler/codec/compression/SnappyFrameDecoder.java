...
import static org.glowroot.agent.shaded.netty.handler.codec.compression.Snappy.validateChecksum;

/**
 * Uncompresses a {@link ByteBuf} encoded with the Snappy framing format.
 *
 * See <a href="https://github.org.glowroot.agent.shaded.google/snappy/blob/master/framing_format.txt">Snappy framing format</a>.
 *
