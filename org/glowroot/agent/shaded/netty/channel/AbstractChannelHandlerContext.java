...
import org.glowroot.agent.shaded.netty.util.Attribute;
import org.glowroot.agent.shaded.netty.util.AttributeKey;
import org.glowroot.agent.shaded.netty.util.DefaultAttributeMap;
import org.glowroot.agent.shaded.netty.util.Recycler;
import org.glowroot.agent.shaded.netty.util.ReferenceCountUtil;
import org.glowroot.agent.shaded.netty.util.ResourceLeakHint;
import org.glowroot.agent.shaded.netty.util.concurrent.EventExecutor;
import org.glowroot.agent.shaded.netty.util.concurrent.OrderedEventExecutor;
import org.glowroot.agent.shaded.netty.util.internal.PromiseNotificationUtil;
...
abstract class AbstractChannelHandlerContext extends DefaultAttributeMap
    ...
    abstract static class AbstractWriteTask implements Runnable {
        ...
        private static final boolean ESTIMATE_TASK_SIZE_ON_SUBMIT =
                SystemPropertyUtil.getBoolean("org.glowroot.agent.shaded.netty.transport.estimateSizeOnSubmit", true);

        // Assuming a 64-bit JVM, 16 bytes object header, 3 reference fields and one int field, plus alignment
        private static final int WRITE_TASK_OVERHEAD =
                SystemPropertyUtil.getInt("org.glowroot.agent.shaded.netty.transport.writeTaskSizeOverhead", 48);
