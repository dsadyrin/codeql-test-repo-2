 ...
 */
package org.glowroot.agent.shaded.h2.command;
...
import org.glowroot.agent.shaded.h2.api.Trigger;
import org.glowroot.agent.shaded.h2.command.ddl.AlterIndexRename;
import org.glowroot.agent.shaded.h2.command.ddl.AlterSchemaRename;
import org.glowroot.agent.shaded.h2.command.ddl.AlterTableAddConstraint;
import org.glowroot.agent.shaded.h2.command.ddl.AlterTableAlterColumn;
import org.glowroot.agent.shaded.h2.command.ddl.AlterTableDropConstraint;
import org.glowroot.agent.shaded.h2.command.ddl.AlterTableRename;
import org.glowroot.agent.shaded.h2.command.ddl.AlterTableRenameColumn;
import org.glowroot.agent.shaded.h2.command.ddl.AlterUser;
import org.glowroot.agent.shaded.h2.command.ddl.AlterView;
import org.glowroot.agent.shaded.h2.command.ddl.Analyze;
import org.glowroot.agent.shaded.h2.command.ddl.CreateAggregate;
import org.glowroot.agent.shaded.h2.command.ddl.CreateConstant;
import org.glowroot.agent.shaded.h2.command.ddl.CreateFunctionAlias;
import org.glowroot.agent.shaded.h2.command.ddl.CreateIndex;
import org.glowroot.agent.shaded.h2.command.ddl.CreateLinkedTable;
import org.glowroot.agent.shaded.h2.command.ddl.CreateRole;
import org.glowroot.agent.shaded.h2.command.ddl.CreateSchema;
import org.glowroot.agent.shaded.h2.command.ddl.CreateSequence;
import org.glowroot.agent.shaded.h2.command.ddl.CreateTable;
import org.glowroot.agent.shaded.h2.command.ddl.CreateTableData;
import org.glowroot.agent.shaded.h2.command.ddl.CreateTrigger;
import org.glowroot.agent.shaded.h2.command.ddl.CreateUser;
import org.glowroot.agent.shaded.h2.command.ddl.CreateUserDataType;
import org.glowroot.agent.shaded.h2.command.ddl.CreateView;
import org.glowroot.agent.shaded.h2.command.ddl.DeallocateProcedure;
import org.glowroot.agent.shaded.h2.command.ddl.DefineCommand;
import org.glowroot.agent.shaded.h2.command.ddl.DropAggregate;
import org.glowroot.agent.shaded.h2.command.ddl.DropConstant;
import org.glowroot.agent.shaded.h2.command.ddl.DropDatabase;
import org.glowroot.agent.shaded.h2.command.ddl.DropFunctionAlias;
import org.glowroot.agent.shaded.h2.command.ddl.DropIndex;
import org.glowroot.agent.shaded.h2.command.ddl.DropRole;
import org.glowroot.agent.shaded.h2.command.ddl.DropSchema;
import org.glowroot.agent.shaded.h2.command.ddl.DropSequence;
import org.glowroot.agent.shaded.h2.command.ddl.DropTable;
import org.glowroot.agent.shaded.h2.command.ddl.DropTrigger;
import org.glowroot.agent.shaded.h2.command.ddl.DropUser;
import org.glowroot.agent.shaded.h2.command.ddl.DropUserDataType;
import org.glowroot.agent.shaded.h2.command.ddl.DropView;
import org.glowroot.agent.shaded.h2.command.ddl.GrantRevoke;
import org.glowroot.agent.shaded.h2.command.ddl.PrepareProcedure;
import org.glowroot.agent.shaded.h2.command.ddl.SetComment;
import org.glowroot.agent.shaded.h2.command.ddl.TruncateTable;
import org.glowroot.agent.shaded.h2.command.dml.AlterSequence;
import org.glowroot.agent.shaded.h2.command.dml.AlterTableSet;
import org.glowroot.agent.shaded.h2.command.dml.BackupCommand;
import org.glowroot.agent.shaded.h2.command.dml.Call;
import org.glowroot.agent.shaded.h2.command.dml.Delete;
import org.glowroot.agent.shaded.h2.command.dml.ExecuteProcedure;
import org.glowroot.agent.shaded.h2.command.dml.Explain;
import org.glowroot.agent.shaded.h2.command.dml.Insert;
import org.glowroot.agent.shaded.h2.command.dml.Merge;
import org.glowroot.agent.shaded.h2.command.dml.NoOperation;
import org.glowroot.agent.shaded.h2.command.dml.Query;
import org.glowroot.agent.shaded.h2.command.dml.Replace;
import org.glowroot.agent.shaded.h2.command.dml.RunScriptCommand;
import org.glowroot.agent.shaded.h2.command.dml.ScriptCommand;
import org.glowroot.agent.shaded.h2.command.dml.Select;
import org.glowroot.agent.shaded.h2.command.dml.SelectOrderBy;
import org.glowroot.agent.shaded.h2.command.dml.SelectUnion;
import org.glowroot.agent.shaded.h2.command.dml.Set;
import org.glowroot.agent.shaded.h2.command.dml.SetTypes;
import org.glowroot.agent.shaded.h2.command.dml.TransactionCommand;
import org.glowroot.agent.shaded.h2.command.dml.Update;
import org.glowroot.agent.shaded.h2.constraint.ConstraintReferential;
...
import org.glowroot.agent.shaded.h2.engine.FunctionAlias;
import org.glowroot.agent.shaded.h2.engine.Procedure;
...
import org.glowroot.agent.shaded.h2.engine.User;
import org.glowroot.agent.shaded.h2.engine.UserAggregate;
import org.glowroot.agent.shaded.h2.engine.UserDataType;
import org.glowroot.agent.shaded.h2.expression.Aggregate;
import org.glowroot.agent.shaded.h2.expression.Alias;
import org.glowroot.agent.shaded.h2.expression.CompareLike;
import org.glowroot.agent.shaded.h2.expression.Comparison;
import org.glowroot.agent.shaded.h2.expression.ConditionAndOr;
import org.glowroot.agent.shaded.h2.expression.ConditionExists;
import org.glowroot.agent.shaded.h2.expression.ConditionIn;
import org.glowroot.agent.shaded.h2.expression.ConditionInSelect;
import org.glowroot.agent.shaded.h2.expression.ConditionNot;
import org.glowroot.agent.shaded.h2.expression.Expression;
import org.glowroot.agent.shaded.h2.expression.ExpressionColumn;
import org.glowroot.agent.shaded.h2.expression.ExpressionList;
import org.glowroot.agent.shaded.h2.expression.Function;
import org.glowroot.agent.shaded.h2.expression.FunctionCall;
import org.glowroot.agent.shaded.h2.expression.JavaAggregate;
import org.glowroot.agent.shaded.h2.expression.JavaFunction;
import org.glowroot.agent.shaded.h2.expression.Operation;
import org.glowroot.agent.shaded.h2.expression.Parameter;
import org.glowroot.agent.shaded.h2.expression.Rownum;
import org.glowroot.agent.shaded.h2.expression.SequenceValue;
import org.glowroot.agent.shaded.h2.expression.Subquery;
import org.glowroot.agent.shaded.h2.expression.TableFunction;
import org.glowroot.agent.shaded.h2.expression.ValueExpression;
import org.glowroot.agent.shaded.h2.expression.Variable;
import org.glowroot.agent.shaded.h2.expression.Wildcard;
import org.glowroot.agent.shaded.h2.index.Index;
import org.glowroot.agent.shaded.h2.message.DbException;
import org.glowroot.agent.shaded.h2.result.SortOrder;
...
import org.glowroot.agent.shaded.h2.table.FunctionTable;
import org.glowroot.agent.shaded.h2.table.IndexColumn;
import org.glowroot.agent.shaded.h2.table.RangeTable;
import org.glowroot.agent.shaded.h2.table.Table;
import org.glowroot.agent.shaded.h2.table.TableFilter;
import org.glowroot.agent.shaded.h2.table.TableView;
import org.glowroot.agent.shaded.h2.table.TableFilter.TableFilterVisitor;
import org.glowroot.agent.shaded.h2.util.MathUtils;
import org.glowroot.agent.shaded.h2.util.New;
import org.glowroot.agent.shaded.h2.util.StatementBuilder;
import org.glowroot.agent.shaded.h2.util.StringUtils;
import org.glowroot.agent.shaded.h2.value.CompareMode;
import org.glowroot.agent.shaded.h2.value.DataType;
import org.glowroot.agent.shaded.h2.value.Value;
import org.glowroot.agent.shaded.h2.value.ValueBoolean;
import org.glowroot.agent.shaded.h2.value.ValueBytes;
import org.glowroot.agent.shaded.h2.value.ValueDate;
import org.glowroot.agent.shaded.h2.value.ValueDecimal;
import org.glowroot.agent.shaded.h2.value.ValueInt;
import org.glowroot.agent.shaded.h2.value.ValueLong;
import org.glowroot.agent.shaded.h2.value.ValueNull;
import org.glowroot.agent.shaded.h2.value.ValueString;
import org.glowroot.agent.shaded.h2.value.ValueTime;
import org.glowroot.agent.shaded.h2.value.ValueTimestamp;
...
public class Parser {
    ...
    /**
     * @see org.glowroot.agent.shaded.h2.engine.DbSettings#databaseToUpper
     */
