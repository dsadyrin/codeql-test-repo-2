...
//## AWT ##
    ...
    private boolean createTrayIcon() {
        try {
            ...
            if (d.width >= 24 && d.height >= 24) {
                iconFile = "/org.glowroot.agent.shaded.h2/res/h2-24.png";
                ...
                iconFile = "/org.glowroot.agent.shaded.h2/res/h2-64-t.png";
                // iconFile = "/org.glowroot.agent.shaded.h2/res/h2-22-t.png";
            } else {
                iconFile = "/org.glowroot.agent.shaded.h2/res/h2.png";
            }
    ...
    private void showWindow() {
        ...
        Image image = loadImage("/org.glowroot.agent.shaded.h2/res/h2.png");
        if (image != null) {
