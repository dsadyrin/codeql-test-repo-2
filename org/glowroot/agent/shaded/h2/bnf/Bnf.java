 ...
 */
package org.glowroot.agent.shaded.h2.bnf;
...
import org.glowroot.agent.shaded.h2.bnf.context.DbContextRule;
...
public class Bnf {
    ...
    public static Bnf getInstance(Reader csv) throws SQLException, IOException {
        Bnf bnf = new Bnf();
        if (csv == null) {
            byte[] data = Utils.getResource("/org.glowroot.agent.shaded.h2/res/help.csv");
