 ...
 */
package org.glowroot.agent.shaded.h2.table;
...
import org.glowroot.agent.shaded.h2.command.Command;
import org.glowroot.agent.shaded.h2.constraint.Constraint;
import org.glowroot.agent.shaded.h2.constraint.ConstraintCheck;
import org.glowroot.agent.shaded.h2.constraint.ConstraintReferential;
import org.glowroot.agent.shaded.h2.constraint.ConstraintUnique;
...
import org.glowroot.agent.shaded.h2.engine.QueryStatisticsData;
import org.glowroot.agent.shaded.h2.engine.Right;
import org.glowroot.agent.shaded.h2.engine.Role;
import org.glowroot.agent.shaded.h2.engine.Session;
import org.glowroot.agent.shaded.h2.engine.Setting;
...
import org.glowroot.agent.shaded.h2.index.MetaIndex;
import org.glowroot.agent.shaded.h2.index.MultiVersionIndex;
import org.glowroot.agent.shaded.h2.message.DbException;
import org.glowroot.agent.shaded.h2.mvstore.FileStore;
import org.glowroot.agent.shaded.h2.mvstore.db.MVTableEngine.Store;
...
import org.glowroot.agent.shaded.h2.schema.Constant;
...
import org.glowroot.agent.shaded.h2.tools.Csv;
...
import org.glowroot.agent.shaded.h2.value.ValueStringIgnoreCase;
...
public class MetaTable extends Table {
    ...
    public ArrayList<Row> generateRows(Session session, SearchRow first,
        ...
        case HELP: {
            String resource = "/org.glowroot.agent.shaded.h2/res/help.csv";
            try {
