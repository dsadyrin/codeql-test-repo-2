...
public class DbDriverActivator implements BundleActivator {
    ...
    public void start(BundleContext bundleContext) {
        org.glowroot.agent.shaded.h2.Driver driver = org.glowroot.agent.shaded.h2.Driver.load();
        Properties properties = new Properties();
        properties.put(
                DataSourceFactory.OSGI_JDBC_DRIVER_CLASS,
                org.glowroot.agent.shaded.h2.Driver.class.getName());
        properties.put(
    ...
    public void stop(BundleContext bundleContext) {
        org.glowroot.agent.shaded.h2.Driver.unload();
    }
