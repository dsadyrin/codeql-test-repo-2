...
import org.glowroot.agent.shaded.h2.store.fs.FilePathEncrypt;
import org.glowroot.agent.shaded.h2.store.fs.FilePathRec;
...
public class ConnectionInfo implements Cloneable {
    ...
    public ConnectionInfo(String u, Properties info) {
        ...
        if (recoverTest != null) {
            ...
            try {
                Utils.callStaticMethod("org.glowroot.agent.shaded.h2.store.RecoverTester.init", recoverTest);
            } catch (Exception e) {
