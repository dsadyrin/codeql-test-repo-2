...
import org.glowroot.agent.shaded.h2.command.CommandRemote;
...
import org.glowroot.agent.shaded.h2.value.Transfer;
        ...
        try {
            ...
            if (sessionFactory == null) {
                sessionFactory = (SessionFactory) Class.forName(
                        "org.glowroot.agent.shaded.h2.engine.Engine").newInstance();
            }
