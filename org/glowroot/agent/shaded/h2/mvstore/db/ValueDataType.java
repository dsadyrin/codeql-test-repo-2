 ...
 */
package org.glowroot.agent.shaded.h2.mvstore.db;
...
import org.glowroot.agent.shaded.h2.mvstore.WriteBuffer;
import org.glowroot.agent.shaded.h2.mvstore.rtree.SpatialDataType;
import org.glowroot.agent.shaded.h2.mvstore.rtree.SpatialKey;
import org.glowroot.agent.shaded.h2.mvstore.type.DataType;
...
import org.glowroot.agent.shaded.h2.value.ValueByte;
...
import org.glowroot.agent.shaded.h2.value.ValueFloat;
import org.glowroot.agent.shaded.h2.value.ValueGeometry;
import org.glowroot.agent.shaded.h2.value.ValueInt;
import org.glowroot.agent.shaded.h2.value.ValueJavaObject;
...
import org.glowroot.agent.shaded.h2.value.ValueShort;
import org.glowroot.agent.shaded.h2.value.ValueString;
import org.glowroot.agent.shaded.h2.value.ValueStringFixed;
        ...
        case Value.RESULT_SET: {
            ...
            try {
                ...
                while (rs.next()) {
                    buff.put((byte) 1);
                    for (int i = 0; i < columnCount; i++) {
                        int t = org.glowroot.agent.shaded.h2.value.DataType.
                                getValueTypeFromResultSet(meta, i + 1);
                        Value val = org.glowroot.agent.shaded.h2.value.DataType.readValue(
                                null, rs, i + 1, t);
                        writeValue(buff, val);
                    }
                }
