...
import org.glowroot.agent.shaded.h2.server.Service;
import org.glowroot.agent.shaded.h2.server.ShutdownHandler;
...
public class WebServer implements Service {
    ...
    private static final String[] GENERIC = {
        ...
        "Generic H2 (Server)|org.glowroot.agent.shaded.h2.Driver|" +
                "jdbc:h2:tcp://localhost/~/test|sa",
        // this will be listed on top for new installations
        "Generic H2 (Embedded)|org.glowroot.agent.shaded.h2.Driver|" +
                "jdbc:h2:~/test|sa",
    };
...
//                // "src/main/org.glowroot.agent.shaded.h2/server/web/res/_text_cs.prop"), -1);
//                "src/main/org.glowroot.agent.shaded.h2/res/_messages_cs.prop"), -1);
...
//    }
    ...
    byte[] getFile(String file) throws IOException {
        ...
        byte[] data = Utils.getResource("/org.glowroot.agent.shaded.h2/server/web/res/" + file);
        if (data == null) {
            trace(" null");
        } else {
...
//            }
    ...
    Connection getConnection(String driver, String databaseUrl, String user,
        ...
        org.glowroot.agent.shaded.h2.Driver.load();
        ...
        if (databaseUrl.startsWith("jdbc:h2:")) {
            ...
            // Properties
            return org.glowroot.agent.shaded.h2.Driver.load().connect(databaseUrl, p);
        }
//            try {
