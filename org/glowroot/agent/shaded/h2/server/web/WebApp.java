 ...
 */
package org.glowroot.agent.shaded.h2.server.web;
...
import org.glowroot.agent.shaded.h2.bnf.Bnf;
import org.glowroot.agent.shaded.h2.bnf.context.DbColumn;
import org.glowroot.agent.shaded.h2.bnf.context.DbContents;
import org.glowroot.agent.shaded.h2.bnf.context.DbSchema;
import org.glowroot.agent.shaded.h2.bnf.context.DbTableOrView;
import org.glowroot.agent.shaded.h2.engine.Constants;
import org.glowroot.agent.shaded.h2.engine.SysProperties;
import org.glowroot.agent.shaded.h2.jdbc.JdbcSQLException;
import org.glowroot.agent.shaded.h2.message.DbException;
import org.glowroot.agent.shaded.h2.security.SHA256;
import org.glowroot.agent.shaded.h2.tools.Backup;
import org.glowroot.agent.shaded.h2.tools.ChangeFileEncryption;
import org.glowroot.agent.shaded.h2.tools.ConvertTraceFile;
import org.glowroot.agent.shaded.h2.tools.CreateCluster;
import org.glowroot.agent.shaded.h2.tools.DeleteDbFiles;
import org.glowroot.agent.shaded.h2.tools.Recover;
import org.glowroot.agent.shaded.h2.tools.Restore;
import org.glowroot.agent.shaded.h2.tools.RunScript;
import org.glowroot.agent.shaded.h2.tools.Script;
...
import org.glowroot.agent.shaded.h2.util.Profiler;
import org.glowroot.agent.shaded.h2.util.ScriptReader;
import org.glowroot.agent.shaded.h2.util.SortedProperties;
...
public class WebApp {
            ...
            if (e instanceof SQLException) {
                ...
                if (isH2) {
                    ...
                    error += " <a href=\"http://h2database.com/javadoc/" +
                            "org.glowroot.agent.shaded.h2/constant/ErrorCode.html#c" + code +
                            "\">(${text.a.help})</a>";
                }
            }
    ...
    private static String linkToSource(String s) {
        try {
            ...
            while (true) {
                int start = s.indexOf("org.glowroot.agent.shaded.h2.", idx);
                if (start < 0) {
