 ...
 */
package org.glowroot.agent.shaded.h2.server.pg;
...
import org.glowroot.agent.shaded.h2.jdbc.JdbcPreparedStatement;
import org.glowroot.agent.shaded.h2.jdbc.JdbcStatement;
    ...
    private static void installPgCatalog(Statement stat) throws SQLException {
        ...
        try {
            r = new InputStreamReader(new ByteArrayInputStream(Utils
                    .getResource("/org.glowroot.agent.shaded.h2/server/pg/pg_catalog.sql")));
