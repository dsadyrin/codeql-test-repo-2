...
// the use of org.glowroot.agent.jul is changed during shading to use org.glowroot.agent.jul instead
// so that shaded libraries that use org.glowroot.agent.jul (e.g. shaded guava), will be redirected to
...
public class Logger {
    ...
    private final org.glowroot.agent.shaded.slf4j.Logger slf4jLogger;
    ...
    private Logger(String name) {
        this(org.glowroot.agent.shaded.slf4j.LoggerFactory.getLogger(name));
    }

    @VisibleForTesting
    Logger(org.glowroot.agent.shaded.slf4j.Logger logger) {
        this.slf4jLogger = logger;
    }

    @VisibleForTesting
    org.glowroot.agent.shaded.slf4j.Logger getSlf4jLogger() {
        return slf4jLogger;
    }
