...
public class Agent {
    ...
    private static final org.glowroot.agent.shaded.slf4j.Logger logger = LoggerFactory.getLogger(Agent.class);
    ...
    static class LoggerImpl implements Logger {
        ...
        private final org.glowroot.agent.shaded.slf4j.Logger logger;

        @VisibleForTesting
        public LoggerImpl(org.glowroot.agent.shaded.slf4j.Logger logger) {
            this.logger = logger;
        }
